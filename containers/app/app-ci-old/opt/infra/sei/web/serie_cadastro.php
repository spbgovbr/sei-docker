...
?>
  ...
  <div id="divNome" class="infraAreaDados" style="height:5em;">
    ...
    <input type="text" id="txtNome" name="txtNome" class="infraText" value="<?=PaginaSEI::tratarHTML($objSerieDTO->getStrNome());?>" onkeypress="return infraMascaraTexto(this,event,50);" maxlength="50" />
  </div>
  ...
  <div id="divDescricao" class="infraAreaDados" style="height:7em;">
    ...
    <textarea id="txaDescricao" name="txaDescricao" rows="<?=PaginaSEI::getInstance()->isBolNavegadorFirefox()?'1':'2'?>" class="infraTextarea" onkeypress="return infraMascaraTexto(this,event,250);" ><?=PaginaSEI::tratarHTML($objSerieDTO->getStrDescricao());?></textarea>
  </div>
