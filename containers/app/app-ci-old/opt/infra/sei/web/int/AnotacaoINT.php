...
class AnotacaoINT extends InfraINT {
  ...
  public static function montarIconeAnotacao($objAnotacaoDTO, $bolAcaoRegistrarAnotacao, $dblIdProtocolo, $strParametros = ''){
    ...
    if ($objAnotacaoDTO!=null) {
      ...
      $ret = '<a href="'.$strLink.'" '.PaginaSEI::montarTitleTooltip($objAnotacaoDTO->getStrDescricao(),$objAnotacaoDTO->getStrSiglaUsuario()) . '><img src="' . ($objAnotacaoDTO->getStrSinPrioridade() == 'N' ? Icone::ANOTACAO1 : Icone::ANOTACAO2) . '" class="imagemStatus" /></a>';
