...
try {
  ...
  $strDisplayNomeArvore = 'display:none;';
  ...
  if ($_GET['acao']=='documento_gerar' ||
    ...
    $strDisplayNumero = 'display:block;';
    $strDisplayNomeArvore = 'display:block;';
...
?>
  ...
  #txtDataElaboracao {position:absolute;left:53%;top:36%;width:16%;}
  #imgDataElaboracao {position:absolute;left:70%;top:41%;}
  ...
  #lblOuModeloFavorito {position:absolute;left:57%;top:25%;}
  #btnEscolherDocumentoTextoBase {position:absolute;left:60.5%;top:18%;}

  #divOptTextoPadrao {position:absolute;left:13%;top:47%;}
  #selTextoPadrao {position:absolute;left:40%;top:45%;width:55%}

  #divOptNenhum   {position:absolute;left:13%;top:72%;}

  #divNumero {<?=$strDisplayNumero?>}
  #lblNumero {position:absolute;left:0;top:0;}
  #txtNumero {position:absolute;left:0;top:36%;width:10%;}
  #lblNomeArvore {position:absolute;left:13%;top:0;<?=$strDisplayNomeArvore?>}
  #txtNomeArvore {position:absolute;left:13%;top:36%;width:37%;<?=$strDisplayNomeArvore?>}
  ...
  #lblTipoConferencia {position:absolute;left:53%;top:10%;width:32%;<?=$strDisplayOpcoesDigitalizado?>}
  #selTipoConferencia {position:absolute;left:53%;top:34%;width:32%;<?=$strDisplayOpcoesDigitalizado?>}

  #divSinArquivamento {position:absolute;left:53%;top:73%;<?=$strDisplayOpcoesDigitalizado?>}
...
?>
  <form id="frmDocumentoCadastro" method="post" onsubmit="return OnSubmitForm();" action="<?=SessaoSEI::getInstance()->assinarLink('controlador.php?acao='.$_GET['acao'].'&acao_origem='.$_GET['acao'].$strParametros)?>" style="display:inline;">
    ...
    <div id="divNumero" class="infraAreaDados" style="height:5em;">
