...
class PainelControleRN extends InfraRN
{
  ...
  protected function carregarConfiguracoesConectado()
  {
    try {
      ...
      $this->lerSinalizador($arrConfiguracao, $objPainelControleDTO, 'SinVerGruposBlocosZerados', 'S');
      ...
      $this->lerSinalizador($arrConfiguracao, $objPainelControleDTO, 'SinVerMarcadoresZerados', 'S');
      ...
      $this->lerSinalizador($arrConfiguracao, $objPainelControleDTO, 'SinVerAtribuicoesZeradas', 'S');
      ...
      $this->lerSinalizador($arrConfiguracao, $objPainelControleDTO, 'SinVerAcompanhamentosZerados', 'S');
