...
try {
  ...
  switch($_GET['acao']){
    ...
    case 'usuario_externo_incluir_documento':
      ...
      $arrComandos[] = '<button type="submit" accesskey="S" name="sbmIncluirDocumento" id="sbmIncluirDocumento" value="Salvar" class="infraButton" style="display: none;"></button>';
  ...
  $strItensSelSerie = SerieINT::montarSelectUsuarioExterno('null','&nbsp;',$numIdSerie, $_GET['id_acesso_externo']);
...
?>
  ...
  <form id="frmAnexos" style="margin:0;border:0;padding:0;">
    <div class="infraAreaDados" style="height: 3em;">
      <label id="lblArquivo" for="filArquivo" accesskey="" class="infraLabelObrigatorio">Documento:</label>
      <input type="file" id="filArquivo" name="filArquivo" size="50" onchange="objUpload.executar();" tabindex="1000"/><br />
    </div>
    <button type="button" accesskey="S" value="Salvar" class="infraButton" onclick="$('#sbmIncluirDocumento').click()"><span class="infraTeclaAtalho">S</span>alvar</button>
