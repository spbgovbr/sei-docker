...
class InfraSequencia extends InfraRN {
  ...
  protected function obterProximaSequenciaControlado($strTabela) {
    ...
    if (BancoInfra::getInstance() instanceof InfraSqlServer) {
      ...
      $sql = 'update infra_sequencia set num_atual = num_atual + qtd_incremento OUTPUT Inserted.num_atual where nome_tabela = ' . BancoInfra::getInstance()->formatarGravacaoStr($strTabela);
