...
?>
  ...
  <select id="selEsquemaLogin" name="selEsquemaLogin" class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
  ...
  <label id="lblSta2Fatores" for="selSta2Fatores" accesskey="" class="infraLabelObrigatorio">Autenticação em 2 Fatores:</label>
  <select id="selSta2Fatores" name="selSta2Fatores" class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
...
<div id="divServicos" class="infraAreaDados" style="height:15em;">
  <label id="lblServicos" for="selServicos" class="infraLabelOpcional">Serviços Liberados para Acesso no SIP:</label>
  <input type="hidden" id="hdnServicos" name="hdnServicos" class="infraText" value="" />
  <select id="selServicos" name="selServicos" size="7" multiple="multiple" class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
    <?=$strItensSelServicos?>
  </select>
  <div id="divOpcoesServicos">
    <img id="imgPesquisarServicos" onclick="objLupaServicos.selecionar(700,500);" src="<?=PaginaSip::getInstance()->getIconePesquisar()?>" alt="Seleção de Serviços" title="Seleção de Serviços" class="infraImg" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />
    <img id="imgExcluirServicos" onclick="objLupaServicos.remover();" src="<?=PaginaSip::getInstance()->getIconeRemover()?>" alt="Remover Serviços Selecionados" title="Remover Serviços Selecionados" class="infraImg" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />
  </div>
</div>
...
?>
  ...
  &nbsp;&nbsp;
  <img id="imgRemover" src="<?=PaginaSip::getInstance()->getIconeRemover()?>" alt="Remover Logo" title="Remover Logo" style="<?=$strDisplayRemover?>" class="infraImg" onclick="removerLogo();" />
