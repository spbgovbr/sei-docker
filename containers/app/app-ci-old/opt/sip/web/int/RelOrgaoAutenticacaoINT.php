...
class RelOrgaoAutenticacaoINT extends InfraINT {
  ...
  public static function montarSelectServidoresAutenticacao($numIdOrgao){
    ...
    foreach($arrObjRelOrgaoAutenticacaoDTO as $objRelOrgaoAutenticacaoDTO){
      $objRelOrgaoAutenticacaoDTO->setStrNomeServidorAutenticacao(ServidorAutenticacaoINT::formatarIdentificacao($objRelOrgaoAutenticacaoDTO->getStrNomeServidorAutenticacao(),$objRelOrgaoAutenticacaoDTO->getStrEnderecoServidorAutenticacao()));
    }
