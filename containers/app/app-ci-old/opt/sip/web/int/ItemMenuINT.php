...
class ItemMenuINT extends InfraINT {
  ...
  public static function montarSelectRotulo($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdMenu='', $numIdSistema='', $numIdMenuPai='', $numIdItemMenuPai='', $strIdRecurso=''){
  ...
  public static function montarSelectRamificacao($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdMenu){
  ...
  public static function montarSelectRamificacaoOutros($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdMenu, $numIdItemMenu){
