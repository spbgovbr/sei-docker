...
try {
  ...
  if ($bolAcaoBlocoAssinaturaListar){
    $strLinkIrParaBlocos = '<a id="ancIrBlocosAssinatura" href="javascript:void(0);" onclick="irBlocosAssinatura();" class="ancoraPadraoPreta">Ir para Blocos de Assinatura</a>';
