...
require_once dirname(__FILE__).'/SEI.php';
 ...
 class SessaoSEI extends InfraSessao {
  ...
  private $strSinAcessibilidade = null;
  ...
  public function getStrSinAcessibilidade(){
    if ($this->strSinAcessibilidade==null){
      $this->strSinAcessibilidade = $this->getAtributo('acessibilidade');
    }
    return $this->strSinAcessibilidade;
  }
