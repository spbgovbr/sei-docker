...
<?if($bolExecutouOK){?>
  var frmOpener = window.opener.document.getElementById('frmProcedimentoAcervoSigilososUnidade');
  window.opener.document.getElementById('hdnInfraItensSelecionados').value = '';
