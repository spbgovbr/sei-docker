...
try {
  ...
  PaginaSEI::getInstance()->prepararPaginacao($objContatoDTO, 500);
...
<form id="frmContatoLista" method="post" onsubmit="return OnSubmitForm();" action="<?=SessaoSEI::getInstance()->assinarLink('controlador.php?acao='.$_GET['acao'].'&acao_origem='.$_GET['acao'])?>">
  ...
  <label id="lblContatoAssociado" class="infraLabelOpcional" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>">Pessoa Jurídica Associada:</label>
