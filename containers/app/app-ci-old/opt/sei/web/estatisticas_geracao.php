  ...
  switch($_GET['acao']){
    ...
    case 'gerar_estatisticas_ouvidoria':
    	...
    	if ($_GET['acao']=='gerar_estatisticas_unidade'){
    		...
    		$strEscolhaOrgao = 'visibility:hidden';
    		$bolOuvidoria = false;
    	}else{
...
#lblOrgao	{position:absolute;left:0%;top:5%;<?=$strEscolhaOrgao?>}
#selOrgao	{position:absolute;left:7%;top:0%;width:11%;<?=$strEscolhaOrgao?>}	
