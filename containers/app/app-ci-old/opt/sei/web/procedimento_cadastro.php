...
?>
    ...
    <div id="divProtocoloInformar" class="infraAreaDados" style="height:11em;">
      ...
      <fieldset id="fldProtocoloInformar" class="infraFieldset">
        <legend class="infraLegend">Protocolo</legend>
          ...
          <img src="<?=PaginaSEI::getInstance()->getIconeCalendario()?>" id="imgCalDtaGeracaoInformar" title="Selecionar Data" alt="Selecionar Data"  class="infraImg" onclick="infraCalendario('txtDtaGeracaoInformar',this);" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
  ...
  <? if ($bolNumeroProcessoAlterar){ ?>
    <div id="divProtocoloAlterar" class="infraAreaDados" style="height:5em;">
      ...
      <input type="text" id="txtProtocoloAlterar" name="txtProtocoloAlterar"  <?=(InfraString::isBolVazia($strMascaraProtocolo)?'':'onkeypress="return infraMascara(this,event,\''.$strMascaraProtocolo.'\');"')?> class="infraText" value="<?=PaginaSEI::tratarHTML($objProtocoloDTO->getStrProtocoloFormatado());?>" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
      ...
      <img src="<?=PaginaSEI::getInstance()->getIconeCalendario()?>" id="imgCalDtaGeracaoAlterar" title="Selecionar Data" alt="Selecionar Data"  class="infraImg" onclick="infraCalendario('txtDtaGeracaoAlterar',this);" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
    </div>
  <? } ?>
