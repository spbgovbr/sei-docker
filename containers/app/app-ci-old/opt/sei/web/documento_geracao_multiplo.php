...
#selProcedimentos {position:absolute;left:0%;top:17%;width:89%;}
...
#divTextoInicial {height:11em;<?=$strDisplayTextoInicial?>}
#fldTextoInicial {position:absolute;left:0%;top:5%;height:80%;width:88%;}
...
#btnEscolherDocumentoTextoBase {position:absolute;left:60.5%;top:25%;visibility:hidden;}
#divOptTextoPadrao {position:absolute;left:13%;top:60%;}
#selTextoPadrao {position:absolute;left:40%;top:60%;width:45%;visibility:hidden;}
...
#btnNovoAssinatura {position:absolute;left:79%;top:35%;width:10%;}
...
#btnEscolherDocumentoTextoBase {top:15%;}
#divOptTextoPadrao {top:55%;}
#selTextoPadrao {top:50%;}
