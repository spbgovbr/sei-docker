...
try {
  ...
  if ($strSinBloquearIdentificacao=='S' || $_GET['acao']=='contato_consultar') {
...
?>
    ...
    #lblNomeSocial {position:absolute;left:0%;top:75%;width:68%;}
    #txtNomeSocial {position:absolute;left:0%;top:86%;width:68%;}

    #fldNatureza {position:absolute;left:70%;top:5%;height:40%;width:22%;}
    #divOptPessoaFisica {position:absolute;left:12%;top:35%;}
    #divOptPessoaJuridica {position:absolute;left:12%;top:65%;}

    #fldStaGenero {position:absolute;left:70%;top:55%;height:40%;width:22%;}
    ...
    #lblEndereco {position:absolute;left:0%;top:0%;width:94.5%;}
    #txtEndereco {position:absolute;left:0%;top:14%;width:94.5%;}

    #lblComplemento {position:absolute;left:0%;top:33%;width:68%;}
    #txtComplemento {position:absolute;left:0%;top:47%;width:68%;}

    #lblBairro {position:absolute;left:70%;top:33%;width:24.6%;}
    #txtBairro {position:absolute;left:70%;top:47%;width:24.6%;}

    #lblPais {position:absolute;left:0%;top:66%;width:23%;}
    ...
    #lblComplementoAssociado {position:absolute;left:0%;top:33%;width:68%;}
    #txtComplementoAssociado {position:absolute;left:0%;top:47%;width:68%;}

    #lblBairroAssociado {position:absolute;left:70%;top:33%;width:24.6%;}
    ...
    #lblCidadeAssociado {position:absolute;left:35%;top:66%;width:33%;}
    #txtCidadeAssociado {position:absolute;left:35%;top:80%;width:33%;}

    #lblCepAssociado {position:absolute;left:70%;top:66%;width:15%;}
    ...
    #lblTelefoneComercialPF {position:absolute;left:0%;top:0%;width:22%;}
    #txtTelefoneComercialPF {position:absolute;left:0%;top:40%;width:22%;}

    #lblTelefoneCelularPF {position:absolute;left:24%;top:0%;width:21%;}
    #txtTelefoneCelularPF {position:absolute;left:24%;top:40%;width:21%;}

    #lblTelefoneResidencialPF {position:absolute;left:47%;top:0%;width:21%;}
    #txtTelefoneResidencialPF {position:absolute;left:47%;top:40%;width:21%;}

    #divPessoaJuridica {height:5em;display:none;}
    ...
    #lblTelefoneComercialPJ {position:absolute;left:47%;top:0%;width:21%;}
    #txtTelefoneComercialPJ {position:absolute;left:47%;top:40%;width:21%;}

    #lblTelefoneCelularPJ {position:absolute;left:70%;top:0%;width:24.6%;}
    #txtTelefoneCelularPJ {position:absolute;left:70%;top:40%;width:24.6%;}

    #divConjuge {height:5em;}
    #lblConjuge {position:absolute;left:0%;top:0%;width:68%;}
    #txtConjuge {position:absolute;left:0%;top:40%;width:68%;}

    #divEmail {height:5em;<?=(!$bolExibirEmail?'display:none':'')?>}
...
?>
    <form id="frmContatoCadastro" method="post" onsubmit="return OnSubmitForm();" action="<?=SessaoSEI::getInstance()->assinarLink('controlador.php?acao='.$_GET['acao'].'&acao_origem='.$_GET['acao'].'&id_tipo_contato='.$objContatoDTO->getNumIdTipoContato().'&sta_natureza='.$objContatoDTO->getStrStaNatureza().'&id_pais='.$objContatoDTO->getNumIdPais().'&id_uf='.$objContatoDTO->getNumIdUf().'&id_cidade='.$objContatoDTO->getNumIdCidade().'&id_pais_passaporte='.$objContatoDTO->getNumIdPaisPassaporte().'&bloquear_identificacao='.$strSinBloquearIdentificacao.'&bloquear_externo='.$strSinBloquearExterno)?>">
      <?
      ...
      ?>
        ...
        <div id="divPessoaFisicaTelefones" class="infraAreaDados">
            ...
            <input type="text" id="txtTelefoneComercialPF" name="txtTelefoneComercialPF" <?=$strTagReadOnlyExterno?> class="infraText<?=$strCssReadOnlyExterno?>" value="<?=PaginaSEI::tratarHTML($objContatoDTO->getStrTelefoneComercial());?>" onkeypress="return infraMascaraTexto(this,event,50);" maxlength="50" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" />
