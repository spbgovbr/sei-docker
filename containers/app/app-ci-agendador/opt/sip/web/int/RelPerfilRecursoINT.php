...
class RelPerfilRecursoINT extends InfraINT {
  ...
  public static function montarSelectNomeRecurso($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdPerfil='', $numIdRecurso='', $numIdSistema=''){
