...
try {
  ...
  PaginaSip::getInstance()->salvarCamposPost(array('selOrgaoSistema','selSistema','selOrgaoUnidade','selUnidade','selOrgaoUsuario','hdnIdUsuario','txtUsuario','hdnNomeUsuario','hdnSiglaUsuario','selPerfil'));
...
function inicializar(){
  ...
  objAjaxUsuario.selecionar('<?=$objPermissaoDTO->getNumIdUsuario();?>','<?=PaginaSip::getInstance()->formatarParametrosJavascript($objPermissaoDTO->getStrSiglaUsuario(),false);?>','<?=PaginaSip::getInstance()->formatarParametrosJavascript($objPermissaoDTO->getStrNomeUsuario(),false)?>');
...
?>
<form id="frmPermissaoCadastro" method="post" onsubmit="return OnSubmitForm();" action="<?=SessaoSip::getInstance()->assinarLink('permissao_cadastro.php?acao='.$_GET['acao'].'&acao_origem='.$_GET['acao'])?>">
<?
...
?>
  ...
  <select id="selOrgaoSistema" name="selOrgaoSistema" class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" <?=$strDesabilitar?>>
  ...
  <select id="selUnidade" name="selUnidade" onchange="trocarUnidade();" class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" <?=$strDesabilitar?>>
  <?=$strItensSelUnidade?>
  </select>

  <label id="lblOrgaoUsuario" for="selOrgaoUsuario" accesskey="" class="infraLabelObrigatorio">Órgão do Usuário:</label>
  ...
  <label id="lblUsuario" for="txtUsuario" accesskey="o" class="infraLabelObrigatorio">Usuári<span class="infraTeclaAtalho">o</span>:</label>
  <input type="text" id="txtUsuario" name="txtUsuario" class="infraText" value="<?=PaginaSip::tratarHTML($objPermissaoDTO->getStrSiglaUsuario())?>" maxlength="100" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" <?=$strDesabilitar?> />
  ...
  <label id="lblPerfil" for="selPerfil" accesskey="P" class="infraLabelObrigatorio"><span class="infraTeclaAtalho">P</span>erfil:</label>
	<select id="selPerfil" name="selPerfil" class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" <?=$strDesabilitar?>>
  <?=$strItensSelPerfil?>
  </select>
	
  <label id="lblTipoPermissao" for="selTipoPermissao" accesskey="T" class="infraLabelObrigatorio"><span class="infraTeclaAtalho">T</span>ipo:</label>
  <select id="selTipoPermissao" name="selTipoPermissao" class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
  ...
  <input type="text" id="txtDataInicio" name="txtDataInicio" onkeypress="return infraMascaraData(this, event)" class="infraText" value="<?=PaginaSip::tratarHTML($objPermissaoDTO->getDtaDataInicio());?>" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />
  ...
  <input type="text" id="txtDataFim" name="txtDataFim" onkeypress="return infraMascaraData(this, event)" class="infraText" value="<?=PaginaSip::tratarHTML($objPermissaoDTO->getDtaDataFim());?>" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />
  ...
  <div id="divReplicar" class="infraDivCheckbox">
    <input type="checkbox" id="chkReplicar" name="chkReplicar" class="infraCheckbox" <?=PaginaSip::getInstance()->setCheckbox($objPermissaoDTO->getStrSinSubunidades())?> />
  	<label id="lblReplicar" accesskey="" for="chkReplicar" class="infraLabelCheckbox">Estender permissão às subunidades</label>
	</div>
  
  <input type="hidden" id="hdnIdPerfil" name="hdnIdPerfil" value="<?=$objPermissaoDTO->getNumIdPerfil();?>" />
  <input type="hidden" id="hdnIdOrgaoSistema" name="hdnIdOrgaoSistema" value="<?=$objPermissaoDTO->getNumIdOrgaoSistema();?>" />
  <input type="hidden" id="hdnIdSistema" name="hdnIdSistema" value="<?=$objPermissaoDTO->getNumIdSistema();?>" />
  <input type="hidden" id="hdnIdOrgaoUnidade" name="hdnIdOrgaoUnidade" value="<?=$objPermissaoDTO->getNumIdOrgaoUnidade();?>" />
  <input type="hidden" id="hdnIdUnidade" name="hdnIdUnidade" value="<?=$objPermissaoDTO->getNumIdUnidade();?>" />
  <input type="hidden" id="hdnIdOrgaoUsuario" name="hdnIdOrgaoUsuario" value="<?=$objPermissaoDTO->getNumIdOrgaoUsuario();?>" />
  <input type="hidden" id="hdnIdUsuario" name="hdnIdUsuario" value="<?=$objPermissaoDTO->getNumIdUsuario();?>" />
	<input type="hidden" id="hdnSiglaUsuario" name="hdnSiglaUsuario" value="<?=PaginaSip::tratarHTML($objPermissaoDTO->getStrSiglaUsuario());?>" />
  <input type="hidden" id="hdnNomeUsuario" name="hdnNomeUsuario" value="<?=PaginaSip::tratarHTML($objPermissaoDTO->getStrNomeUsuario());?>" />
  <?
