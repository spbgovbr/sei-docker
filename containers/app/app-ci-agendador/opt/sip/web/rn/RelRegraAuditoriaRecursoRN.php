...
class RelRegraAuditoriaRecursoRN extends InfraRN {
  ...
  private function validarNumIdSistema(RelRegraAuditoriaRecursoDTO $objRelRegraAuditoriaRecursoDTO, InfraException $objInfraException){
  ...
  private function validarNumIdRecurso(RelRegraAuditoriaRecursoDTO $objRelRegraAuditoriaRecursoDTO, InfraException $objInfraException){
  ...
  private function validarNumIdRegraAuditoria(RelRegraAuditoriaRecursoDTO $objRelRegraAuditoriaRecursoDTO, InfraException $objInfraException){
