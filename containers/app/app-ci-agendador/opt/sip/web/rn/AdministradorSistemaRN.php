...
class AdministradorSistemaRN extends InfraRN {
  ...
  private function validarNumIdUsuario(AdministradorSistemaDTO $objAdministradorSistemaDTO, InfraException $objInfraException){
  ...
  private function validarNumIdSistema(AdministradorSistemaDTO $objAdministradorSistemaDTO, InfraException $objInfraException){
