...
class RelPerfilItemMenuRN extends InfraRN {
  ...
  private function validarNumIdPerfil(RelPerfilItemMenuDTO $objRelPerfilItemMenuDTO, InfraException $objInfraException){
  ...
  private function validarNumIdSistema(RelPerfilItemMenuDTO $objRelPerfilItemMenuDTO, InfraException $objInfraException){
  ...
  private function validarNumIdItemMenu(RelPerfilItemMenuDTO $objRelPerfilItemMenuDTO, InfraException $objInfraException){
