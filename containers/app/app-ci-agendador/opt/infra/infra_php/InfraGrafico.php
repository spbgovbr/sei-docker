<?
  ...
  */
  ...
  class InfraGrafico {
    ...
    public function gerarGraficoBarrasSimples($arrResultado, $numAlturaGrafico, $strImagem="/infra_css/imagens/barra_area_tabela.gif", $bolEcho=true, $strIdTabela='') {
      $numTotal = 0;
    ...
    public function gerarGraficoBarrasSimplesHorizontal($arrResultado, $numLarguraGrafico, $strImagem="/infra_css/imagens/barra_horizontal_area_tabela.png", $bolEcho=true, $strIdTabela='') {
      $numTotal = 0;
    ...
    public function gerarGraficoBarrasDuplas($arrResultado, $numAlturaGrafico, $strImagem1="/infra_css/imagens/bg_grafico_t.gif", $strImagem2="/infra_css/imagens/bg_grafico_c.gif", $bolEcho = true, $valor1 = null, $valor2 = null) {
   ...
   */
    public function gerarGraficoLinhas($arrResultado, $tituloGrafico='', $subTituloGrafico='', $nomeEixoX='', $nomeEixoY='', $numLarguraGrafico='', $numAlturaGrafico='', $diretorioArquivoSalvo='', $bolEcho=false) {
      $numTotal = 0;
      ...
      foreach($arrResultado as $nomeLinha => $arrValor) {
      	...
      	$graficoLinhas->addDataSeries('L',$ultimoTipoLinha,substr($strValoresLinha,0,strlen($strValoresLinha) - 1),$nomeLinha);
      ...
      if ($bolEcho) {
        	$graficoLinhas->drawGraph();
      		...
      		$nomeArquivoSalvo = $diretorioArquivoSalvo.'/'.session_id().'_'.date("Ymd_His").'_'.rand().'.png';
