...
<option value="azul_celeste" <?=$strEsquema=='azul_celeste'?' selected="selected" ':''?>>Azul Celeste</option>
<option value="cereja" <?=$strEsquema=='cereja'?' selected="selected" ':''?>>Cereja</option>
<option value="verde_limao" <?=$strEsquema=='verde_limao'?' selected="selected" ':''?>>Verde Limão</option>
