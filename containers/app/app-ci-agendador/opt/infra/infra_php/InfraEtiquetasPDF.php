...
class InfraEtiquetasPDF extends InfraPDF {
    ...
    'cerimonial'=>array('name'=>'cerimonial',	'paper-size'=>'letter',	'metric'=>'mm',	'marginLeft'=>11,	'marginTop'=>12, 'NX'=>2,	'NY'=>10,	'SpaceX'=>5,
      'SpaceY'=>1,	'width'=>101.6,		'height'=>24.2,		'font-size'=>6, 'orientacao'=>'V', 'style'=>''),
	);
...
//alterado		
	...
	function _Get_Height_Chars($pt) {
		...
		$_Table_Hauteur_Chars = array( 6=>3.5, 7=>2.5, 8=>3, 9=>4, 10=>5, 11=>6, 12=>7, 13=>8, 14=>9, 15=>10, 20=>10, 90=>20);
	...
	// Constructor
	function InfraEtiquetasPDF ($format, $unit='mm', $posX=1, $posY=1) {
		if (is_array($format)) {
			// Custom format
			$Tformat = $format;
		} else {
