  ...
  if ($numRegistros > 0){
    ...
    */
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      $strResultado .= '<a href="javascript:void(0);" onmouseover="return infraTooltipMostrar(\''.PaginaInfra::getInstance()->formatarParametrosJavaScript($strInformacoesComplementares).'\', \'Informações Complementares\');" onmouseout="return infraTooltipOcultar();" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getIconeInformacao().'" class="infraImg" /></a>&nbsp;';

      if ($bolAcaoExecutar){
      	$strResultado .= '<a onclick="executarAgendamento(\''.$strDescricao.'\',\''.SessaoInfra::getInstance()->assinarLink('controlador.php?acao=infra_agendamento_tarefa_executar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_infra_agendamento_tarefa='.$arrObjInfraAgendamentoTarefaDTO[$i]->getNumIdInfraAgendamentoTarefa()).'\')" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getIconeMarcar().'" title="Executar Agendamento" alt="Executar Agendamento" class="infraImg" /></a>&nbsp;';
      }
            
      if ($bolAcaoConsultar){
        $strResultado .= '<a href="'.SessaoInfra::getInstance()->assinarLink('controlador.php?acao=infra_agendamento_tarefa_consultar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_infra_agendamento_tarefa='.$arrObjInfraAgendamentoTarefaDTO[$i]->getNumIdInfraAgendamentoTarefa()).'" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getIconeConsultar().'" title="Consultar Agendamento" alt="Consultar Agendamento" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoAlterar){
        $strResultado .= '<a href="'.SessaoInfra::getInstance()->assinarLink('controlador.php?acao=infra_agendamento_tarefa_alterar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].'&id_infra_agendamento_tarefa='.$arrObjInfraAgendamentoTarefaDTO[$i]->getNumIdInfraAgendamentoTarefa()).'" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getIconeAlterar().'" title="Alterar Agendamento" alt="Alterar Agendamento" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoDesativar && $arrObjInfraAgendamentoTarefaDTO[$i]->getStrSinAtivo()=='S'){
        $strResultado .= '<a href="'.PaginaInfra::getInstance()->montarAncora($strId).'" onclick="acaoDesativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getIconeDesativar().'" title="Desativar Agendamento" alt="Desativar Agendamento" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoReativar && $arrObjInfraAgendamentoTarefaDTO[$i]->getStrSinAtivo()=='N'){
        $strResultado .= '<a href="'.PaginaInfra::getInstance()->montarAncora($strId).'" onclick="acaoReativar(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getIconeReativar().'" title="Reativar Agendamento" alt="Reativar Agendamento" class="infraImg" /></a>&nbsp;';
      }

      if ($bolAcaoExcluir){
        $strResultado .= '<a href="'.PaginaInfra::getInstance()->montarAncora($strId).'" onclick="acaoExcluir(\''.$strId.'\',\''.$strDescricao.'\');" tabindex="'.PaginaInfra::getInstance()->getProxTabTabela().'"><img src="'.PaginaInfra::getInstance()->getIconeExcluir().'" title="Excluir Agendamento" alt="Excluir Agendamento" class="infraImg" /></a>&nbsp;';
      }
