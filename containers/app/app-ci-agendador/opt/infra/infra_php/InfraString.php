...
/** 
  ...
  */ 	
  ...
  public static function prepararPesquisaDTO(InfraDTO $objDto, $strAtributo, $strAtributoPesquisa = null, $bolUnsetAtributo = true, $bolSomenteLetrasNumeros = false) {
        ...
        if (!InfraString::isBolVazia($strPalavrasPesquisa)) {
          ...
          if ($numPalavrasPesquisa) {
            ...
            if ($numPalavrasPesquisa == 1) {
              ...
              if ($strAtributo == $strAtributoPesquisa){
