...
class IPThOrdenacaoBS4 extends AbstractIPThOrdenacao
{
    ...
    public function render() {
        ...
        $botaoOrdenacaoAsc = $this->criarBotaoOrdenacao('arrow_drop_up', $classeOrdAsc, $onclickAsc, $tabIndexAsc, 'Ascendente');
        $botaoOrdenacaoDesc = $this->criarBotaoOrdenacao('arrow_drop_down', $classeOrdDesc, $onclickDesc, $tabIndexDesc, 'Descendente');
