...
#selAssinantes {position:absolute;left:0%;top:35%;width:95.5%;}
  ...
  <div id="divImprensaOficial" class="infraAreaDados" style="height:10em;">
    <fieldset id="fldImprensaOficial" class="infraFieldset">
   	<legend class="infraLegend">Imprensa Nacional</legend>
		  ...
		  <img id="imgCalPublicacaoIO" title="Selecionar Data" alt="Selecionar Data" src="<?=PaginaSEI::getInstance()->getIconeCalendario()?>" class="infraImg" onclick="infraCalendario('txtDataIO',this);"/>
