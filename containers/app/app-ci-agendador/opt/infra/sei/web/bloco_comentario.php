...
#txaDescricao {position:absolute;left:0%;top:7%;width:90%;}
<?
...
?>
  ...
  <textarea id="txaDescricao" name="txaDescricao" rows="<?=PaginaSEI::getInstance()->isBolNavegadorFirefox()?'16':'17'?>" onkeypress="return infraLimitarTexto(this,event,2000);" class="infraTextarea" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"><?=PaginaSEI::tratarHTML($objBlocoComentarDTO->getStrTextoComentario());?></textarea>
