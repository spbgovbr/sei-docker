 ...
 */    }else{
    ...
    */
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolCheck){
        $strResultado .= '<td valign="top">'.PaginaSip::getInstance()->getTrCheck($i,$arrObjServidorAutenticacaoDTO[$i]->getNumIdServidorAutenticacao(),ServidorAutenticacaoINT::formatarIdentificacao($arrObjServidorAutenticacaoDTO[$i]->getStrNome(),$arrObjServidorAutenticacaoDTO[$i]->getStrEndereco())).'</td>';
      }
