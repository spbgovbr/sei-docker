...
class RelHierarquiaUnidadeINT extends InfraINT {
  ...
  public static function montarSelectSiglaUnidade($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdHierarquia='', $numIdUnidade='', $numIdHierarquiaPai='', $numIdUnidadePai=''){
  ...
  public static function montarSelectSiglaUnidadeOutras($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdHierarquia, $numIdUnidade){
	...
	public static function montarSelectSiglaUnidadeNova($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdOrgaoUnidade, $numIdHierarquia){
    ...
    $objRelHierarquiaUnidadeDTO->setBolExclusaoLogica(false);
		...
		$strPalavrasPesquisa = InfraString::transformarCaixaAlta(trim($strPalavrasPesquisa));
		...
		if (count($arrPalavrasPesquisa)==1){
			...
			$objRelHierarquiaUnidadeDTO->adicionarCriterio(array_fill(0,count($arrPalavrasPesquisa),'SiglaUnidade'),
			...
			$objRelHierarquiaUnidadeDTO->adicionarCriterio(array_fill(0,count($arrPalavrasPesquisa),'DescricaoUnidade'),
					array_fill(0,count($arrPalavrasPesquisa),InfraDTO::$OPER_LIKE),
					$arrPalavrasPesquisa,
