function infraMapa(divId, pontos, descItemSingular, descItemPlural) {
  ...
  this.atualizar = function() {
    ...
    var node = me.grp2.selectAll("g").data(nodes.slice(1), function (d) { return d.id || (d.id = ++me.idx); });
  ...
  this.click = function(d) {
    ...
    if (!d.id_ponto) {
      ...
      infraAbrirJanela(d.href, 'janelaMapa' + d.id_ponto, 750, 550, 'location=0,status=1,resizable=1,scrollbars=1', false);
    }
  }
