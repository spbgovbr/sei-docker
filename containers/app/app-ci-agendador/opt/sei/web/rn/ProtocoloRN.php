 ...
 */
  ...
  protected function obterSequenciaConectado(ProtocoloDTO $parObjProtocoloDTO){
    ...
    $objRelProtocoloProtocoloDTO->setStrStaAssociacao(array(RelProtocoloProtocoloRN::$TA_DOCUMENTO_ASSOCIADO, RelProtocoloProtocoloRN::$TA_DOCUMENTO_MOVIDO, RelProtocoloProtocoloRN::$TA_PROCEDIMENTO_ANEXADO, RelProtocoloProtocoloRN::$TA_PROCEDIMENTO_DESANEXADO),InfraDTO::$OPER_IN);
