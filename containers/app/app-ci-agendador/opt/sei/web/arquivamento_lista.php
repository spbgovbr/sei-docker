...
try {
  ...
  if ($bolAcaoProtocoloArquivamentoPesquisar && $_GET['acao']=='arquivamento_listar'){
    $arrComandos[] = '<button type="button" accesskey="o" id="btnPesquisar" value="Consultar" onclick="infraAbrirJanela(\''.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=arquivamento_pesquisar&acao_origem='.$_GET['acao']).'\',\'janelaArquivamentoPesquisa\',800,600,\'location=0,status=1,resizable=1,scrollbars=1\',true);" class="infraButton" style="">C<span class="infraTeclaAtalho">o</span>nsultar</button>';
...
#selTipoLocalizador {position:absolute;left:0%;top:17%;width:60%;}

#lblLocalizador {position:absolute;left:0%;top:50%;}
#selLocalizador {position:absolute;left:0%;top:67%;width:40%;}
