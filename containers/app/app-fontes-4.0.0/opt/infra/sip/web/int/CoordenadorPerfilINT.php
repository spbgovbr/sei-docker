...
class CoordenadorPerfilINT extends InfraINT {
  ...
  public static function montarSelectIdPerfil($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdPerfil='', $numIdUsuario='', $numIdSistema=''){
