...
try {
  ...
  $arrComandos[] = '<button type="button" accesskey="P" name="btnProtocolos" value="Protocolos" onclick="location.href=\''.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=processo_consulta_federacao&acao_origem='.$_GET['acao']).'\';" class="infraButton"><span class="infraTeclaAtalho">P</span>rotocolos</button>';
