...
function comparar(link){
  ...
  infraAbrirJanela('','janelaComparacao',800,600,'location=0,status=1,resizable=1,scrollbars=1');

  var form=document.getElementById('frmVersaoSecaoDocumentoLista');
  form.target='janelaComparacao';
  form.action = link;
  form.submit();
}
