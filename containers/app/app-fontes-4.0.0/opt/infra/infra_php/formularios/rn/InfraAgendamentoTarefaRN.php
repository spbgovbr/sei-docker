  ...
  private function validarStrPeriodicidadeComplemento(InfraAgendamentoTarefaDTO $objInfraAgendamentoTarefaDTO, InfraException $objInfraException){
    if (InfraString::isBolVazia($objInfraAgendamentoTarefaDTO->getStrPeriodicidadeComplemento())){
      ...
      if (strlen($objInfraAgendamentoTarefaDTO->getStrPeriodicidadeComplemento())>200){
        $objInfraException->adicionarValidacao('Complemento da Periodicidade possui tamanho superior a 200 caracteres.');
      }

      $strPeriodicidadeComplemento = str_replace(' ','',$objInfraAgendamentoTarefaDTO->getStrPeriodicidadeComplemento());
