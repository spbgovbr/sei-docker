...
@section('body-content')
    ...
    <div class="container">
        ...
        <p>
            Aqui é possível ver um exemplo de um formulário completo, fazendo uso de personalizações específicas do renderer Bootstrap4. </p>
        ...
        <form action="" class="needs-validation" novalidate>
            ...
            <div class="form-row">
                ...
                echo UI::inputText('Nome', 'nome_n')
                    ->placeholder('José')
                    ->required()
                    ->append('<small class="text-muted form-text">Primeira letra deve ser maiúscula</small>')
            ...
            <?= UI::checkbox('Sem residência fixa', 'sem_residencia_fixa');?>
            ...
            <div class="form-row">
                ...
                echo UI::inputText('CEP', 'cep')
                    ->customize(function (BS4InputText $el) {
                        $el->_wrapper->class('col-md-2');
                    });
                ?>
            </div>
