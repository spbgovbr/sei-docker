...
class Parser
{
            ...
            if ($inHeader) {
                ...
                if (strlen($line) > 0 && $line[0] == "-") {
                    if (strcmp(trim($line), '--' . $boundary) === 0) {
                        ...
                        // TODO: correção para tratamento de linhas iniciadas com hifen no arquivo enviado por MTOM ainda pendente de aceitação de Merge Request no Github no projeto BeSimpleSoap
                        $content .= $line . "\r\n";
                    }
                } else {
    ...
    private static function parseContentTypeHeader(PartHeader $part, $headerName, $headerValue)
    {
        ...
        while (strlen($remainder) > 0) {
            ...
            // TODO: correção enviada pela AGU, ainda pendente de contribuição no Github no projeto BeSimpleSoap
