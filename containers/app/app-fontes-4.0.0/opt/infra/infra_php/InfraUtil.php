...
class InfraUtil {
  ...
  public static function validarEmail($email){
    ...
    */
    ...
    $regexp='/^\#([\w-]+(\.[\w-]+)*@(([A-Za-z\d-]{0,62}[A-Za-z\d]\.)+[A-Za-z]{2,6}|\[\d{1,3}(\.\d{1,3}){3}\])|([^<^>^"]*)\<[\w-]+(\.[\w-]+)*@(([A-Za-z\d-]{0,62}[A-Za-z\d]\.)+[A-Za-z]{2,6}|\[\d{1,3}(\.\d{1,3}){3}\])\>|((\s)*"[^"]*"(\s)*)\<[\w-]+(\.[\w-]+)*@(([A-Za-z\d-]{0,62}[A-Za-z\d]\.)+[A-Za-z]{2,6}|\[\d{1,3}(\.\d{1,3}){3}\])\>)\#$/i';
