...
abstract class AbstractInfraPaginaRendererFactory
{
     ...
     * @param bool $bolMontarTabIndexPaginacao
    ...
    )
    {
        ...
        return new $class($objInfraPagina, $hasTabIndex, $strSelecao, $strCampo, $isOrdenacaoDescAtiva, $isOrdenacaoAscAtiva, $strRotulo, $strCustomCallbackJs);
    }
