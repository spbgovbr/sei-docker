...
function inicializar(){
  ...
  <?if ($bolCadastroOk){?>
    ...
    if (parent.document.getElementById('ifrVisualizacao')!=null){
      parent.document.getElementById('ifrVisualizacao').contentWindow.recarregarMarcadores('<?=$objMarcadorDTO->getNumIdMarcador()?>');
    }else{
