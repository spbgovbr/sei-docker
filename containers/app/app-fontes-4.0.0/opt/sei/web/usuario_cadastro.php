...
#ancAjuda img {vertical-align:bottom;padding-left:.3em;}
<?
...
?>
  ...
  <div id="divSinAcessibilidade" class="infraDivCheckbox">
    ...
    <a href="javascript:void(0);" id="ancAjuda" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>" <?=PaginaSEI::montarTitleTooltip('É necessário que o usuário realize novo login no sistema para que esta alteração tenha efeito.')?>><img src="<?=PaginaSEI::getInstance()->getIconeAjuda()?>" class="infraImg"/></a>
  </div>
