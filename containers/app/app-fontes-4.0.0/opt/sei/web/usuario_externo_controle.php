...
try {
  ...
  if ($numRegistros){
    ...
    foreach($arrObjAcessoExternoDTO as $objAcessoExternoDTO){
      ...
      if (!$bolExpirado && $objAcessoExternoDTO->getStrSinInclusao() == "S"){
