...
try {
  ...
  if ($bolAcaoCadastrar){
    ...
    /*
      ...
      $arrComandos[] = '<button type="button" accesskey="N" id="btnNova" value="Nova" style="width:10em;" onclick="location.href=\''.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=base_conhecimento_cadastrar&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'])).'\'" class="infraButton"><span class="infraTeclaAtalho">N</span>ova</button>';
  		...
  		$arrComandos[] = '<button type="button" accesskey="N" id="btnNova" value="Nova" style="width:10em;" onclick="alert(\'Para criar uma nova base de conhecimento é necessário utilizar o navegador Internet Explorer.\');" class="infraButton"><span class="infraTeclaAtalho">N</span>ova</button>';
  	}
  	*/
  }
  ...
  if ($numRegistros > 0){
    ...
    if ($bolFlagLiberar){
      $arrComandos[] = '<button type="button" accesskey="L" id="btnLiberar" value="Liberar" onclick="acaoLiberacaoMultipla();" class="infraButton" style="width:10em;"><span class="infraTeclaAtalho">L</span>iberar</button>';
    ...
    if ($bolFlagExcluir){
      $arrComandos[] = '<button type="button" accesskey="E" id="btnExcluir" value="Excluir" onclick="acaoExclusaoMultipla();" class="infraButton" style="width:10em;"><span class="infraTeclaAtalho">E</span>xcluir</button>';
  ...
  if ($_GET['acao'] == 'base_conhecimento_selecionar'){
    $arrComandos[] = '<button type="button" accesskey="F" id="btnFecharSelecao" value="Fechar" onclick="window.close();" class="infraButton" style="width:10em;"><span class="infraTeclaAtalho">F</span>echar</button>';
  }else{
