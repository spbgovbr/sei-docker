...
#txtNome {position:absolute;left:0%;top:10%;width:75%;}
...
function inicializar(){
  ...
  <?if ($bolOk){?>
    ...
    <? if ($_GET['arvore']=='1'){ ?>
    var sel = parent.document.getElementById('ifrVisualizacao').contentWindow.document.getElementById('selGrupoAcompanhamento');
    <? }else{ ?>
