...
class VersaoSipRN extends InfraScriptVersao {
  ...
  public function versao_3_0_0($strVersaoAtual){
    try{
      ...
      $numIdPerfilSipAdministradorSistema = ScriptSip::obterIdPerfil($numIdSistemaSip,'Administrador de Sistema');
      $numIdPerfilSipBasico = ScriptSip::obterIdPerfil($numIdSistemaSip,'Básico');
      ...
      BancoSip::getInstance()->executarSql('delete from login');
		#linhas comentadas por causa de erro na execução do script
      ...
      ScriptSip::adicionarItemMenu($numIdSistemaSip,$numIdPerfilSipAdministradorSip, $numIdMenuSip, $numIdItemMenuSipInfra,$objRecursoDTO->getNumIdRecurso(),'Módulos', 0);
      ...
      ScriptSip::adicionarItemMenu($numIdSistemaSip,$numIdPerfilSipAdministradorSip, $numIdMenuSip, $numIdItemMenuSipInfra,$objRecursoDTO->getNumIdRecurso(),'Cache em Memória', 0);
      ...
      BancoSip::getInstance()->executarSql('insert into infra_parametro (nome,valor) values (\'SIP_MSG_USUARIO_BLOQUEADO\',\'Usuário bloqueado.\')');
      ...
      BancoSip::getInstance()->executarSql('
        ...
        VALUES
        (1,\'Ativação da Autenticação em 2 Fatores\',
           \'@sigla_sistema@/@sigla_orgao_sistema@ <@email_sistema@>\',
           \'@nome_usuario@ <@email_usuario@>\',\'Ativação da Autenticação em 2 Fatores\',
           \'A autenticação em 2 fatores foi solicitada para sua conta no sistema @sigla_sistema@/@sigla_orgao_sistema@ em @data@ às @hora@.'.
      ...
      BancoSip::getInstance()->executarSql('
        INSERT INTO email_sistema (id_email_sistema,descricao,de,para,assunto,conteudo,sin_ativo,id_email_sistema_modulo)
        VALUES
        (2,\'Desativação da Autenticação em 2 Fatores\',
           \'@sigla_sistema@/@sigla_orgao_sistema@ <@email_sistema@>\',
           \'@nome_usuario@ <@email_usuario@>\',\'Desativação da Autenticação em 2 Fatores\',
           \'A desativação da autenticação em 2 fatores foi solicitada para sua conta no sistema @sigla_sistema@/@sigla_orgao_sistema@ em @data@ às @hora@.'.
          $objInfraMetaBD->novaLinha().
          $objInfraMetaBD->novaLinha().
      ...
      BancoSip::getInstance()->executarSql('
        INSERT INTO email_sistema (id_email_sistema,descricao,de,para,assunto,conteudo,sin_ativo,id_email_sistema_modulo) 
        VALUES 
        (3,\'Alerta de segurança sobre acesso em outro dispositivo\',
           \'@sigla_sistema@/@sigla_orgao_sistema@ <@email_sistema@>\',
           \'@email_usuario@\',\'Alerta de Segurança\',
           \'Sua conta no sistema @sigla_sistema@/@sigla_orgao_sistema@ foi acessada a partir de um novo dispositivo em @data@ às @hora@.'.
          $objInfraMetaBD->novaLinha().
          $objInfraMetaBD->novaLinha().
      ...
      BancoSip::getInstance()->executarSql('
        INSERT INTO email_sistema (id_email_sistema,descricao,de,para,assunto,conteudo,sin_ativo,id_email_sistema_modulo) 
        VALUES 
        (4,\'Bloqueio do usuário por link em e-mail de alerta de segurança\',
           \'@sigla_sistema@/@sigla_orgao_sistema@ <@email_sistema@>\',
           \'@email_usuario@\',\'Aviso de Bloqueio\',
           \'Sua conta no sistema @sigla_sistema@/@sigla_orgao_sistema@ foi bloqueada em @data@ às @hora@.\',
           \'S\',
           null)');
      ...
      ScriptSip::adicionarItemMenu($numIdSistemaSip,$numIdPerfilSipAdministradorSip, $numIdMenuSip, null, $objRecursoDTO->getNumIdRecurso(),'Autenticação em 2 Fatores', 160);
      ...
      BancoSip::getInstance()->executarSql('update item_menu set icone=\'orgao.svg\' where rotulo=\'Órgãos\' and id_item_menu_pai is null and id_sistema='.$numIdSistemaSip);
      ...
      BancoSip::getInstance()->executarSql('update item_menu set icone=\'usuario.svg\' where rotulo=\'Usuários\' and id_item_menu_pai is null and id_sistema='.$numIdSistemaSip);
      ...
      BancoSip::getInstance()->executarSql('update item_menu set icone=\'permissao.svg\' where rotulo=\'Permissões\' and id_item_menu_pai is null and id_sistema='.$numIdSistemaSip);
      ...
      BancoSip::getInstance()->executarSql('update item_menu set icone=\'servidor_autenticacao.svg\' where rotulo=\'Servidores de Autenticação\' and id_item_menu_pai is null and id_sistema='.$numIdSistemaSip);
      BancoSip::getInstance()->executarSql('update item_menu set icone=\'2fa.svg\' where rotulo=\'Autenticação em 2 Fatores\' and id_item_menu_pai is null and id_sistema='.$numIdSistemaSip);
