 ...
 */    }else{
    ...
    */
    ...
    for($i = 0;$i < $numRegistros; $i++){
      ...
      if ($bolCheck){
        $strResultado .= '<td valign="top">'.PaginaSip::getInstance()->getTrCheck($i,$arrObjEmailSistemaDTO[$i]->getNumIdEmailSistema(),$arrObjEmailSistemaDTO[$i]->getNumIdEmailSistema()).'</td>';
      }
