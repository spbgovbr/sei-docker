...
try {
  ...
  switch($_GET['acao']){
	...
	if ($numRegistros > 0){
		...
		$arrPerfisReservados = $objInfraParametro->listarValores(array('ID_PERFIL_SIP_ADMINISTRADOR_SISTEMA','ID_PERFIL_SIP_COORDENADOR_PERFIL','ID_PERFIL_SIP_COORDENADOR_UNIDADE','ID_PERFIL_SIP_ADMINISTRADOR_SIP'));
