...
#lblEntidade {position:absolute;left:0%;top:32%;width:50%;}
#txtEntidade {position:absolute;left:0%;top:38%;width:50%;}
...
?>
<form id="frmRecursoCadastro" method="post" onsubmit="return OnSubmitForm();" action="<?=SessaoSip::getInstance()->assinarLink('recurso_gerar.php?acao='.$_GET['acao'].'&acao_origem='.$_GET['acao'])?>">
<?
...
?>
  <label id="lblOrgaoSistema" for="selOrgaoSistema" accesskey="m" class="infraLabelObrigatorio">Órgão do Siste<span class="infraTeclaAtalho">m</span>a:</label>
  ...
  <label id="lblEntidade" for="txtEntidade" accesskey="N" class="infraLabelObrigatorio"><span class="infraTeclaAtalho">E</span>ntidade (separar por vírgula ',' para mais de uma entidade):</label>
  <input type="text" id="txtEntidade" name="txtEntidade" class="infraText" value="<?=PaginaSip::tratarHTML($objRecursoPadraoDTO->getStrEntidade());?>" maxlength="50" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />
  
  <label id="lblCaminhoBase" for="txtCaminhoBase" accesskey="C" class="infraLabelObrigatorio">Caminho <span class="infraTeclaAtalho">B</span>ase:</label>
  <input type="text" id="txtCaminhoBase" name="txtCaminhoBase" class="infraText" value="<?=PaginaSip::tratarHTML($objRecursoPadraoDTO->getStrCaminhoBase());?>" maxlength="255" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" />
