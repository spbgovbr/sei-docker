...
class RelHierarquiaUnidadeRN extends InfraRN {
  ...
  protected function alterarControlado(RelHierarquiaUnidadeDTO $objRelHierarquiaUnidadeDTO){
    try {
      ...
      $objInfraException->lancarValidacoes();
			...
			//Data inicial não pode ser modificada
			$objRelHierarquiaUnidadeDTO->unSetDtaDataInicio();
  ...
  protected function listarHierarquiaConectado(RelHierarquiaUnidadeDTO $parObjRelHierarquiaUnidadeDTO){
	...
	private function validarNumIdUnidade(RelHierarquiaUnidadeDTO $objRelHierarquiaUnidadeDTO, InfraException $objInfraException){
	...
	private function validarNumIdHierarquia(RelHierarquiaUnidadeDTO $objRelHierarquiaUnidadeDTO, InfraException $objInfraException){
  ...
  private function validarDtaDataInicio(RelHierarquiaUnidadeDTO $objRelHierarquiaUnidadeDTO, InfraException $objInfraException){
	...
	private function validarDtaDataFim(RelHierarquiaUnidadeDTO $objRelHierarquiaUnidadeDTO, InfraException $objInfraException){
	...
	private function validarPeriodoDatas(RelHierarquiaUnidadeDTO $objRelHierarquiaUnidadeDTO, InfraException $objInfraException){  	
  ...
  private function validarStrSinAtivo(RelHierarquiaUnidadeDTO $objRelHierarquiaUnidadeDTO, InfraException $objInfraException){
