...
?>
  <form id="frmHierarquiaCadastro" method="post" onsubmit="return OnSubmitForm();"
    ...
    <input type="text" id="txtNome" name="txtNome" class="infraText"
           value="<?=PaginaSip::tratarHTML($objHierarquiaDTO->getStrNome());?>" maxlength="50"
    ...
    <input type="text" id="txtDescricao" name="txtDescricao" class="infraText"
           value="<?=PaginaSip::tratarHTML($objHierarquiaDTO->getStrDescricao());?>" maxlength="200"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    ...
    <input type="text" id="txtDataInicio" name="txtDataInicio" onkeypress="return infraMascaraData(this, event)"
           class="infraText" value="<?=PaginaSip::tratarHTML($objHierarquiaDTO->getDtaDataInicio());?>"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    ...
    <input type="text" id="txtDataFim" name="txtDataFim" onkeypress="return infraMascaraData(this, event)"
           class="infraText" value="<?=PaginaSip::tratarHTML($objHierarquiaDTO->getDtaDataFim());?>"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    ...
    <input type="hidden" id="hdnIdHierarquia" name="hdnIdHierarquia"
           value="<?=$objHierarquiaDTO->getNumIdHierarquia();?>"/>
    <?
