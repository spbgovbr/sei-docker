...
class ScriptSip {
  ...
  public static function cadastrarPerfil(
    $numIdSistemaSei, $strNomePerfil, $strDescricao, $sinAtivo, $sinCoordenado, $sin2Fatores = 'N') {
    try {
      $objPerfilRN = new PerfilRN();
      $objPerfilDTO = new PerfilDTO();
      $objPerfilDTO->retNumIdPerfil();
      ...
      if ($ret == null) {
        ...
        $objPerfilDTO->setStrSin2Fatores($sin2Fatores);
  ...
  public static function adicionarItemMenu(
    $numIdSistema, $numIdPerfil, $numIdMenu, $numIdItemMenuPai, $numIdRecurso, $strRotulo, $numSequencia, $strIcone = null) {
    try {
      $objItemMenuDTO = new ItemMenuDTO();
      $objItemMenuDTO->retNumIdItemMenu();
      $objItemMenuDTO->setNumIdMenu($numIdMenu);
