...
try {
  ...
  PaginaSip::getInstance()->salvarCamposPost(array(
    'selOrgaoDestino', 'selSistemaDestino', 'selPerfilDestino', 'selOrgaoOrigem', 'selSistemaOrigem', 'selPerfilOrigem', 'txtOrgaoOrigem', 'txtSistemaOrigem', 'txtPerfilOrigem'
  ));
    ...
    for ($i = 0; $i < $numRegistros; $i++) {
      ...
      if ($bolAmbos) {//recurso de ambos os perfis
        ...
        if (in_array($itemRecurso, $arrRecursosPerfilLocal)) {
          ...
          if (in_array($itemRecurso, $arrRecursosPerfilRemoto)) {
            $strResultado .= $strTrClass;
...
?>
  <form id="frmPerfilMontar" method="post" onsubmit="return OnSubmitForm();"
        action="<?=SessaoSip::getInstance()->assinarLink('perfil_comparar.php?acao=' . $_GET['acao'] . '&acao_Destino=' . $_GET['acao'])?>">
    <?
    ...
    ?>
    <label id="lblOrgaoSistemaDestino" for="selOrgaoDestino" accesskey="r" class="infraLabelObrigatorio">Ó<span
        class="infraTeclaAtalho">r</span>gão do Sistema Destino:</label>
    <select id="selOrgaoDestino" name="selOrgaoDestino" onchange="trocarOrgaoSistemaDestino(this);" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelOrgaosDestino?>
    </select>

    <label id="lblSistemaDestino" for="selSistemaDestino" accesskey="S" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">S</span>istema Destino:</label>
    <select id="selSistemaDestino" name="selSistemaDestino" onchange="trocarSistemaDestino(this);" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelSistemasDestino?>
    </select>

    <label id="lblPerfilDestino" for="selPerfilDestino" accesskey="P" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">P</span>erfil Destino:</label>
    <select id="selPerfilDestino" name="selPerfilDestino" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelPerfisDestino?>
    </select>

    <label id="lblMenuDestino" for="selMenuDestino" accesskey="M" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">M</span>enu Destino:</label>
    <select id="selMenuDestino" name="selMenuDestino" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
    ...
    <div id="divBaseComparacao" class="infraDivRadio">
      <input type="radio" name="rdoBase" id="optBaseLocal" value="L" onclick="processarBaseComparacao(this);"
             class="infraRadio" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" <?=$rdoBaseComparacao == 'L' ? 'checked=checked' : ''?> />
      <label id="lblBaseLocal" accesskey="" for="optBaseLocal" class="infraLabelCheckbox">Base Local</label>

      <input type="radio" name="rdoBase" id="optBaseRemota" value="R" onclick="processarBaseComparacao(this);"
             class="infraRadio" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" <?=$rdoBaseComparacao == 'R' ? 'checked=checked' : ''?> />
      <label id="lblBaseRemota" accesskey="" for="optBaseRemota" class="infraLabelCheckbox">Base Remota</label>
    </div>

    <label id="lblOrgaoSistemaOrigem" for="txtOrgaoOrigem" accesskey="r" class="infraLabelObrigatorio">Ó<span
        class="infraTeclaAtalho">r</span>gão do Sistema Origem:</label>
    <input type="text" id="txtOrgaoOrigem" name="txtOrgaoOrigem" style="display: none;" maxlength="15" class="infraText"
           value="<?=PaginaSip::tratarHTML($objCompararPerfilDTO->getStrSiglaOrgaoSistemaOrigem());?>"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    <select id="selOrgaoOrigem" name="selOrgaoOrigem" onchange="trocarOrgaoSistemaOrigem(this);" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelOrgaosOrigem?>
    </select>

    <label id="lblSistemaOrigem" for="txtSistemaOrigem" accesskey="S" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">S</span>istema Origem:</label>
    <input type="text" id="txtSistemaOrigem" name="txtSistemaOrigem" style="display: none;" class="infraText"
           value="<?=PaginaSip::tratarHTML($objCompararPerfilDTO->getStrSiglaSistemaOrigem());?>"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    <select id="selSistemaOrigem" name="selSistemaOrigem" onchange="trocarSistemaOrigem(this);" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelSistemasOrigem?>
    </select>

    <label id="lblPerfilOrigem" for="txtPerfilOrigem" accesskey="P" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">P</span>erfil Origem:</label>
    <input type="text" id="txtPerfilOrigem" name="txtPerfilOrigem" style="display: none;" class="infraText"
           value="<?=PaginaSip::tratarHTML($objCompararPerfilDTO->getStrPerfilOrigem());?>"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    <select id="selPerfilOrigem" name="selPerfilOrigem" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelPerfisOrigem?>
    </select>

    <div id="divSomenteDiferencas" class="infraDivCheckbox">
      <input type="checkbox" id="chkSomenteDiferencas" name="chkSomenteDiferencas" <?=PaginaSip::getInstance()->setCheckbox($objCompararPerfilDTO->getStrSinSomenteDiferencas())?>
             class="infraCheckbox"/>
      <label id="lblSomenteDiferencas" for="chkSomenteDiferencas" accesskey="t" class="infraLabelObrigatorio">Visualizar
        somen<span class="infraTeclaAtalho">t</span>e diferenças</label>
    </div>
    ...
    <fieldset id="fldBancoOrigem" class="infraFieldset" style="display: none;">
      ...
      <input type="text" id="txtBancoServidor" name="txtBancoServidor" class="infraText"
             value="<?=PaginaSip::tratarHTML($objCompararPerfilDTO->getStrBancoServidor());?>"
             tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
      ...
      <input type="text" id="txtBancoPorta" name="txtBancoPorta" class="infraText"
             value="<?=PaginaSip::tratarHTML($objCompararPerfilDTO->getStrBancoPorta());?>"
             tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

      <label id="lblBancoNome" for="txtBancoNome" accesskey="N" class="infraLabelObrigatorio"><span
          class="infraTeclaAtalho">N</span>ome:</label>
      <input type="text" id="txtBancoNome" name="txtBancoNome" class="infraText"
             value="<?=PaginaSip::tratarHTML($objCompararPerfilDTO->getStrBancoNome());?>"
             tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

      <label id="lblBancoUsuario" for="txtBancoUsuario" accesskey="U" class="infraLabelObrigatorio"><span
          class="infraTeclaAtalho">U</span>suário:</label>
      <input type="text" id="txtBancoUsuario" name="txtBancoUsuario" class="infraText"
             value="<?=PaginaSip::tratarHTML($objCompararPerfilDTO->getStrBancoUsuario());?>"
             tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

      <label id="lblBancoSenha" for="pwdBancoSenha" accesskey="e" class="infraLabelObrigatorio">S<span
      ...
      <input type="password" id="pwdBancoSenha" name="pwdBancoSenha" autocomplete="off" class="infraText"
             value="<?=PaginaSip::tratarHTML($objCompararPerfilDTO->getStrBancoSenha());?>"
             tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
