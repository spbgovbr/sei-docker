...
try {
  ...
  PaginaSip::getInstance()->salvarCamposPost(array(
      'selOrgaoSistemaCodigoAcesso', 'selSistemaCodigoAcesso', 'selOrgaoUsuarioCodigoAcesso', 'hdnIdUsuarioCodigoAcesso', 'txtUsuarioCodigoAcesso', 'hdnSiglaUsuarioCodigoAcesso', 'hdnNomeUsuarioCodigoAcesso', 'selEstadoCodigoAcesso'
    ));
  ...
  switch ($_GET['acao']) {
    ...
    case 'codigo_acesso_listar':
      $strTitulo = '' . 'Habilitações de Autenticação em 2 Fatores';
      break;
...
if (0){ ?>
  <style><?}?>
    ...
    #lblNomeUsuarioCodigoAcesso {
      position: absolute;
      left: 60%;
      top: 70%;
    }

    #lblEstadoCodigoAcesso {
      position: absolute;
      left: 60%;
      top: 0%;
      width: 25%;
...
if (0){ ?>
  <script type="text/javascript"><?}?>
    ...
    function abrirJanelaCodigoAcesso(link) {
      infraAbrirJanelaModal(link, 700, 550);
    }

    function abrirJanelaAcessoCodigoAcesso(link) {
      infraAbrirJanelaModal(link, 1000, 550);
    }
...
?>
  <form id="frmCodigoAcessoLista" method="post" action="<?=SessaoSip::getInstance()->assinarLink('controlador.php?acao=' . $_GET['acao'] . '&acao_origem=' . $_GET['acao'])?>">
    ...
    <label id="lblOrgaoSistemaCodigoAcesso" for="selOrgaoSistemaCodigoAcesso" accesskey="r"
           class="infraLabelObrigatorio">Ó<span class="infraTeclaAtalho">r</span>gão do Sistema:</label>
    <select id="selOrgaoSistemaCodigoAcesso" name="selOrgaoSistemaCodigoAcesso" onchange="this.form.submit();"
            class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelOrgaoSistema?>
    </select>

    <label id="lblSistemaCodigoAcesso" for="selSistemaCodigoAcesso" accesskey="S" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">S</span>istema:</label>
    <select id="selSistemaCodigoAcesso" name="selSistemaCodigoAcesso" onchange="this.form.submit();" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelSistema?>
    </select>

    <label id="lblOrgaoUsuarioCodigoAcesso" for="selOrgaoUsuarioCodigoAcesso" accesskey="o"
           class="infraLabelObrigatorio">Órgã<span class="infraTeclaAtalho">o</span> do Usuário:</label>
    <select id="selOrgaoUsuarioCodigoAcesso" name="selOrgaoUsuarioCodigoAcesso" <?=$strDesabilitarFiltroUsuario?>
            onchange="objAjaxUsuario.limpar();this.form.submit();" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelOrgaoUsuario?>
    </select>

    <label id="lblUsuarioCodigoAcesso" for="txtUsuarioCodigoAcesso" accesskey="u" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">U</span>suário:</label>
    <input type="text" id="txtUsuarioCodigoAcesso" name="txtUsuarioCodigoAcesso" <?=$strDesabilitarFiltroUsuario?>
           class="infraText" value="<?=PaginaSip::tratarHTML($strSiglaUsuario)?>" maxlength="100"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    <label id="lblNomeUsuarioCodigoAcesso" class="infraLabelOpcional"></label>

    <label id="lblEstadoCodigoAcesso" for="selEstadoCodigoAcesso" accesskey=""
           class="infraLabelObrigatorio">Situação:</label>
    <select id="selEstadoCodigoAcesso" name="selEstadoCodigoAcesso" <?=$strDesabilitarFiltroUsuario?>
            onchange="this.form.submit();" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
    ...
    <input type="hidden" id="hdnSiglaUsuarioCodigoAcesso" name="hdnSiglaUsuarioCodigoAcesso"
           value="<?=PaginaSip::tratarHTML($strSiglaUsuario)?>"/>
    <input type="hidden" id="hdnNomeUsuarioCodigoAcesso" name="hdnNomeUsuarioCodigoAcesso"
