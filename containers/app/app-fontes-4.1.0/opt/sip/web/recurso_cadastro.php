...
?>
  <form id="frmRecursoCadastro" method="post" onsubmit="return OnSubmitForm();"
    ...
    <input type="text" id="txtNome" name="txtNome" class="infraText"
           value="<?=PaginaSip::tratarHTML($objRecursoDTO->getStrNome());?>" maxlength="100"
    ...
    <input type="text" id="txtDescricao" name="txtDescricao" class="infraText"
           value="<?=PaginaSip::tratarHTML($objRecursoDTO->getStrDescricao());?>" maxlength="200"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblCaminho" for="txtCaminho" accesskey="C" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">C</span>aminho:</label>
    <input type="text" id="txtCaminho" name="txtCaminho" class="infraText"
           value="<?=PaginaSip::tratarHTML($objRecursoDTO->getStrCaminho());?>" maxlength="255"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblPerfil" for="selPerfil" accesskey="S" class="infraLabelOpcional">Perfis:</label>
    <select id="selPerfil" name="selPerfil" class="infraSelect" size="10" multiple="multiple"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>" <?=$strDesabilitar?>>
      <?=$strItensSelPerfil?>
    </select>
