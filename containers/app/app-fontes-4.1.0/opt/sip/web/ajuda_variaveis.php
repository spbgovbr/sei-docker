        ...
        case EmailSistemaRN::$ES_AVISO_BLOQUEIO:
          ...
          switch ($_GET['campo']) {
            case 'R':
              ...
              $arrVariaveis[] = array(
                '@email_sistema@', 'Endereço eletrônico do sistema configurado no parâmetro SIP_EMAIL_SISTEMA da tabela de parâmetros'
              );
              break;
            ...
            case 'C':
              ...
              if ($_GET['tipo'] == EmailSistemaRN::$ES_ATIVACAO_2_FATORES) {
                ...
                if ($_GET['tipo'] == EmailSistemaRN::$ES_DESATIVACAO_2_FATORES) {
                  $arrVariaveis[] = array(
                    '@endereco_desativacao@', 'Endereço para desativação do mecanismo'
                  );
                } else {
                  if ($_GET['tipo'] == EmailSistemaRN::$ES_ALERTA_SEGURANCA) {
                    $arrVariaveis[] = array(
                      '@endereco_bloqueio@', 'Endereço para bloqueio do usuário'
                    );
                  }
                }
              }
