...
?>
  <form id="frmRecursoLista" method="post" onsubmit="return OnSubmitForm();"
        action="<?=SessaoSip::getInstance()->assinarLink('sistema_clonar.php?acao=' . $_GET['acao'] . '&acao_origem=' . $_GET['acao'])?>">
    <?
    ...
    <label id="lblOrgaoSistemaOrigem" for="selOrgaoSistemaOrigem" accesskey="o" class="infraLabelObrigatorio">Órgã<span
        class="infraTeclaAtalho">o</span> Origem:</label>
    <select id="selOrgaoSistemaOrigem" name="selOrgaoSistemaOrigem" onchange="trocarOrgaoSistema(this);"
            class="infraSelect" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelOrgaoSistemaOrigem?>
    </select>


    <label id="lblSistemaOrigem" for="selSistemaOrigem" accesskey="S" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">S</span>istema Origem:</label>
    <select id="selSistemaOrigem" name="selSistemaOrigem" class="infraSelect"
    ...
    <label id="lblSiglaDestino" for="txtSiglaDestino" accesskey="S" class="infraLabelObrigatorio"><span
        class="infraTeclaAtalho">S</span>igla Destino:</label>
    <input type="text" id="txtSiglaDestino" name="txtSiglaDestino" class="infraText"
           value="<?=PaginaSip::tratarHTML($objClonarSistemaDTO->getStrSiglaDestino());?>" maxlength="15"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
