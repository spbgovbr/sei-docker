...
?>
  <form id="frmEmailSistemaCadastro" method="post" onsubmit="return OnSubmitForm();"
    ...
    <input type="text" id="txtDescricao" name="txtDescricao" readonly="readonly" class="infraText infraReadOnly"
           value="<?=PaginaSip::tratarHTML($objEmailSistemaDTO->getStrDescricao());?>"
    ...
    <input type="text" id="txtDe" name="txtDe" class="infraText"
           value="<?=PaginaSip::tratarHTML($objEmailSistemaDTO->getStrDe());?>"
           onkeypress="return infraMascaraTexto(this,event,250);" maxlength="250"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    <a id="ancAjudaDe" href="javascript:void(0);" onclick="exibirAjuda('<?=$strLinkAjudaRemetente?>');"
       title="Ajuda Remetente" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"><img
    ...
    <input type="text" id="txtPara" name="txtPara" class="infraText"
           value="<?=PaginaSip::tratarHTML($objEmailSistemaDTO->getStrPara());?>"
           onkeypress="return infraMascaraTexto(this,event,250);" maxlength="250"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    <a id="ancAjudaPara" href="javascript:void(0);" onclick="exibirAjuda('<?=$strLinkAjudaDestinatario?>');"
       title="Ajuda Destinatário" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"><img
        src="<?=PaginaSip::getInstance()->getIconeAjuda()?>" class="infraImg"/></a>
    ...
    <input type="text" id="txtAssunto" name="txtAssunto" class="infraText"
           value="<?=PaginaSip::tratarHTML($objEmailSistemaDTO->getStrAssunto());?>"
           onkeypress="return infraMascaraTexto(this,event,250);" maxlength="250"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>
    <a id="ancAjudaAssunto" href="javascript:void(0);" onclick="exibirAjuda('<?=$strLinkAjudaAssunto?>');"
       title="Ajuda Assunto" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"><img
        src="<?=PaginaSip::getInstance()->getIconeAjuda()?>" class="infraImg"/></a>

    <label id="lblConteudo" for="txaConteudo" class="infraLabelObrigatorio">Conteúdo:</label>
    <textarea id="txaConteudo" name="txaConteudo"
              rows="<?=PaginaSip::getInstance()->isBolNavegadorFirefox() ? '14' : '15'?>" class="infraTextarea"
              maxlength="4000" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"><?=PaginaSip::tratarHTML($objEmailSistemaDTO->getStrConteudo());?></textarea>
    <a id="ancAjudaConteudo" href="javascript:void(0);" onclick="exibirAjuda('<?=$strLinkAjudaConteudo?>');"
       title="Ajuda Conteúdo" tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"><img
        src="<?=PaginaSip::getInstance()->getIconeAjuda()?>" class="infraImg"/></a>

    <input type="hidden" id="hdnIdEmailSistema" name="hdnIdEmailSistema"
           value="<?=$objEmailSistemaDTO->getNumIdEmailSistema();?>"/>
    <?
