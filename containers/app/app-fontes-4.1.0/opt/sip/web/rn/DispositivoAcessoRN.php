...
class DispositivoAcessoRN extends InfraRN {
  ...
  private function validarStrIdCodigoAcesso(
    DispositivoAcessoDTO $objDispositivoAcessoDTO, InfraException $objInfraException) {
  ...
  private function validarDthLiberacao(
    DispositivoAcessoDTO $objDispositivoAcessoDTO, InfraException $objInfraException) {
  ...
  private function validarStrIpAcesso(
    DispositivoAcessoDTO $objDispositivoAcessoDTO, InfraException $objInfraException) {
  ...
  private function validarStrChaveAcesso(
    DispositivoAcessoDTO $objDispositivoAcessoDTO, InfraException $objInfraException) {
  ...
  private function validarStrChaveDispositivo(
    DispositivoAcessoDTO $objDispositivoAcessoDTO, InfraException $objInfraException) {
