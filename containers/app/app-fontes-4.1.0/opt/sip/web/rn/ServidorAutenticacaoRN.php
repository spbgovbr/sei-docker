...
class ServidorAutenticacaoRN extends InfraRN {
  ...
  private function validarStrNome(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarStrStaTipo(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarStrEndereco(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarNumPorta(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarStrSufixo(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarStrUsuarioPesquisa(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarStrSenhaPesquisa(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarStrContextoPesquisa(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarStrAtributoFiltroPesquisa(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarStrAtributoRetornoPesquisa(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
  ...
  private function validarNumVersao(
    ServidorAutenticacaoDTO $objServidorAutenticacaoDTO, InfraException $objInfraException) {
