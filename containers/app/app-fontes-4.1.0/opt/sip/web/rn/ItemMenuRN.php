...
class ItemMenuRN extends InfraRN {
  ...
  protected function alterarControlado(ItemMenuDTO $objItemMenuDTO) {
    try {
      ...
      if (($objItemMenuDTO->isSetNumIdSistema() && $objItemMenuDTO->getNumIdSistema() != $dto->getNumIdSistema()) || ($objItemMenuDTO->isSetNumIdRecurso() && $objItemMenuDTO->getNumIdRecurso() != $dto->getNumIdRecurso())) {
