...
class SistemaINT extends InfraINT {
  ...
  public static function montarSelectSigla(
    $strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdOrgao = '', $numIdHierarquia = '') {
  ...
  public static function montarSelectSiglaSip(
    $strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdOrgao = '', $numIdHierarquia = '') {
    $objSistemaDTO = new SistemaDTO();
    $objSistemaDTO->retNumIdSistema();
  ...
  public static function montarSelectTipoBanco(
    $strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado) {
    return parent::montarSelectArray($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, array(
        SistemaRN::$TBD_MYSQL => 'MySql', SistemaRN::$TBD_ORACLE => 'Oracle', SistemaRN::$TBD_POSTGRESQL => 'PostgreSql', SistemaRN::$TBD_SQLSERVER => 'SqlServer'
      ));
  }

  public static function montarSelect2Fatores(
    $strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado) {
    $objSistemaRN = new SistemaRN();
  ...
  public static function montarSelectServicos(
    $strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $strServicos) {
    $objSistemaRN = new SistemaRN();
