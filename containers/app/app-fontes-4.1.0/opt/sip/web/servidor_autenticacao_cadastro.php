  ...
  if (isset($_POST['sbmTestar'])) {
    ...
    try {
      $objInfraLDAP->pesquisaAvancada($objServidorAutenticacaoDTO->getStrStaTipo(), $objServidorAutenticacaoDTO->getStrEndereco(), $objServidorAutenticacaoDTO->getNumPorta(), $objServidorAutenticacaoDTO->getStrUsuarioPesquisa(),
        $objServidorAutenticacaoDTO->getStrSenhaPesquisa(), $objServidorAutenticacaoDTO->getStrContextoPesquisa(), $objServidorAutenticacaoDTO->getStrAtributoFiltroPesquisa(), $objServidorAutenticacaoDTO->getStrAtributoRetornoPesquisa(),
        (InfraString::isBolVazia($objServidorAutenticacaoDTO->getStrSufixo()) ? $_POST['txtUsuarioTeste'] : $_POST['txtUsuarioTeste'] . $objServidorAutenticacaoDTO->getStrSufixo()), $_POST['pwdSenhaTeste'],
...
?>
  <form id="frmServidorAutenticacaoCadastro" method="post" onsubmit="return OnSubmitForm();"
    ...
    <input type="text" id="txtNome" name="txtNome" class="infraText"
           value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getStrNome());?>"
    ...
    <select id="selStaTipo" name="selStaTipo" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelStaTipo?>
    </select>

    <label id="lblVersao" for="selVersao" accesskey="" class="infraLabelObrigatorio">Versão:</label>
    <select id="selVersao" name="selVersao" class="infraSelect"
            tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>">
      <?=$strItensSelVersao?>
    </select>

    <label id="lblEndereco" for="txtEndereco" accesskey="" class="infraLabelObrigatorio">Endereço:</label>
    <input type="text" id="txtEndereco" name="txtEndereco" class="infraText"
           value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getStrEndereco());?>"
    ...
    <input type="text" id="txtPorta" name="txtPorta" onkeypress="return infraMascaraNumero(this, event)"
           class="infraText" value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getNumPorta());?>"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblSufixo" for="txtSufixo" accesskey="" class="infraLabelOpcional">Sufixo:</label>
    <input type="text" id="txtSufixo" name="txtSufixo" class="infraText"
           value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getStrSufixo());?>"
           onkeypress="return infraMascaraTexto(this,event,50);" maxlength="50"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblUsuarioPesquisa" for="txtUsuarioPesquisa" accesskey="" class="infraLabelOpcional">Usuário de
      Pesquisa:</label>
    <input type="text" id="txtUsuarioPesquisa" name="txtUsuarioPesquisa" class="infraText"
           value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getStrUsuarioPesquisa());?>"
           onkeypress="return infraMascaraTexto(this,event,100);" maxlength="100"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblSenhaPesquisa" for="pwdSenhaPesquisa" accesskey="" class="infraLabelOpcional">Senha de
      Pesquisa:</label>
    <input type="password" id="pwdSenhaPesquisa" name="pwdSenhaPesquisa" autocomplete="off" class="infraText"
           value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getStrSenhaPesquisa());?>"
           onkeypress="return infraMascaraTexto(this,event,100);" maxlength="100"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblContextoPesquisa" for="txtContextoPesquisa" accesskey="" class="infraLabelOpcional">* Contexto de
      Pesquisa:</label>
    <input type="text" id="txtContextoPesquisa" name="txtContextoPesquisa" class="infraText"
           value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getStrContextoPesquisa());?>"
           onkeypress="return infraMascaraTexto(this,event,100);" maxlength="100"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblAtributoFiltroPesquisa" for="txtAtributoFiltroPesquisa" accesskey="" class="infraLabelOpcional">*
      Atributo Filtro:</label>
    <input type="text" id="txtAtributoFiltroPesquisa" name="txtAtributoFiltroPesquisa" class="infraText"
           value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getStrAtributoFiltroPesquisa());?>"
           onkeypress="return infraMascaraTexto(this,event,100);" maxlength="100"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblAtributoRetornoPesquisa" for="txtAtributoRetornoPesquisa" accesskey="" class="infraLabelOpcional">*
      Atributo Retorno:</label>
    <input type="text" id="txtAtributoRetornoPesquisa" name="txtAtributoRetornoPesquisa" class="infraText"
           value="<?=PaginaSip::tratarHTML($objServidorAutenticacaoDTO->getStrAtributoRetornoPesquisa());?>"
           onkeypress="return infraMascaraTexto(this,event,100);" maxlength="100"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblAjudaPesquisa" class="infraLabelOpcional">* Estes campos serão obrigatórios caso um deles seja
      informado</label>

    <label id="lblUsuarioTeste" for="txtUsuarioTeste" accesskey="" class="infraLabelOpcional">Usuário de Teste:</label>
    <input type="text" id="txtUsuarioTeste" name="txtUsuarioTeste" class="infraText"
           value="<?=PaginaSip::tratarHTML($_POST['txtUsuarioTeste'])?>"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <label id="lblSenhaTeste" for="pwdSenhaTeste" accesskey="" class="infraLabelOpcional">Senha de Teste:</label>
    <input type="password" id="pwdSenhaTeste" name="pwdSenhaTeste" autocomplete="off" class="infraText"
           value="<?=PaginaSip::tratarHTML($_POST['pwdSenhaTeste'])?>"
           tabindex="<?=PaginaSip::getInstance()->getProxTabDados()?>"/>

    <button type="submit" id="sbmTestar" name="sbmTestar" value="Testar" class="infraButton">Testar</button>

    <input type="hidden" id="hdnIdServidorAutenticacao" name="hdnIdServidorAutenticacao"
           value="<?=$objServidorAutenticacaoDTO->getNumIdServidorAutenticacao();?>"/>
    <?
