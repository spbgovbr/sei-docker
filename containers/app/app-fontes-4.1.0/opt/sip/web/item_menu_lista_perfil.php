    ...
    case 'item_menu_listar_perfil':
      ...
      if ($numRegistros > 0) {
        ...
        for ($i = 0; $i < $numRegistros; $i++) {
          ...
          $strResultado .= '<td valign="center">' . PaginaSip::getInstance()->getTrCheck($i, $arrObjItemMenuDTO[$i]->getNumIdMenu() . '-' . $arrObjItemMenuDTO[$i]->getNumIdItemMenu(), $arrObjItemMenuDTO[$i]->getStrRotulo()) . '</td>';
...
?>
  <form id="frmItemMenuListaPerfil" method="post" onsubmit="return OnSubmitForm();"
