...
class PermissaoDTO extends InfraDTO {
  ...
  public function montar() {
    ...
    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'IdTipoPermissao', 'id_tipo_permissao');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_STR, 'SinSubunidades', 'sin_subunidades');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'DescricaoTipoPermissao', 'descricao', 'tipo_permissao');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdSistemaPerfil', 'id_sistema', 'perfil');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'Sin2FatoresPerfil', 'sin_2_fatores', 'perfil');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SinAtivoSistema', 'sin_ativo', 'sistema');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SinAtivoUsuario', 'sin_ativo', 'usuario');
