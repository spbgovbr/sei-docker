...
class ItemMenuDTO extends InfraDTO {
  ...
  public function montar() {
    ...
    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'IdMenuPai', 'id_menu_pai');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'IdItemMenuPai', 'id_item_menu_pai');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'IdRecurso', 'id_recurso');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_STR, 'Rotulo', 'rotulo');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_STR, 'Descricao', 'descricao');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_STR, 'Icone', 'icone');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'Sequencia', 'sequencia');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_STR, 'SinNovaJanela', 'sin_nova_janela');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_STR, 'SinAtivo', 'sin_ativo');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'NomeMenu', 'nome', 'menu');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdSistemaMenu', 'id_sistema', 'menu');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'CaminhoRecurso', 'caminho', 'recurso');
