...
?>
  <form id="frmPerfilMontar" method="post" onsubmit="return OnSubmitForm();"
        action="<?=SessaoSip::getInstance()->assinarLink('perfil_montar.php?acao=' . $_GET['acao'] . '&acao_origem=' . $_GET['acao'])?>">
    <?
    ...
    <label id="lblNomeRecurso" for="txtNomeRecurso" accesskey="o" class="infraLabelOpcional">Recurs<span
    ...
    <div id="divRecursosPerfil" class="infraDivCheckbox">
      <input type="checkbox" id="chkRecursosPerfil" name="chkRecursosPerfil" onclick="this.form.submit();"
             class="infraCheckbox" <?=PaginaSip::getInstance()->setCheckBox($objPerfilDTO->getStrSinVisualizarProprios())?> <?=$strDesabilitar?>/>
      <label id="lblRecursosPerfil" for="chkRecursosPerfil" class="infraLabelCheckbox">Visualizar Somente Recursos do
        Perfil</label>
    </div>

    <div id="divVisualizarDescricao" class="infraDivCheckbox">
      <input type="checkbox" id="chkVisualizarDescricao" name="chkVisualizarDescricao" onclick="this.form.submit();"
             class="infraCheckbox" <?=PaginaSip::getInstance()->setCheckBox($objPerfilDTO->getStrSinVisualizarDescricao())?> <?=$strDesabilitar?>/>
      <label id="lblVisualizarDescricao" for="chkVisualizarDescricao" class="infraLabelCheckbox">Visualizar Descrição do
        Recurso</label>
    </div>
