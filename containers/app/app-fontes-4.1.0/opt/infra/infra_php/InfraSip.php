...
class InfraSip
{
    ...
    private function getSipWebService()
    {
        ...
        try {
            ...
            throw new InfraException('Erro acessando o Sistema de Permissões.', $e);
        }
    ...
    public function listarCoordenacaoPerfil(
        ...
        try {
            ...
            $this->processarExcecao('Erro listando coordenadores de perfil no Sistema de Permissões.', $e);
        }
    }
    ...
    public function replicarCoordenacaoPerfil($CoordenacoesPerfil)
    {
        try {
            ...
            $this->processarExcecao('Erro replicando coordenações de perfil no Sistema de Permissões.', $e);
        }
    }
    ...
    private function processarExcecao($str, $e)
    {
        if ($e instanceof SoapFault) {
            if (strpos(strtoupper($e->faultstring), 'ERROR FETCHING HTTP HEADERS') !== false) {
                throw new InfraException('Falha na resposta do Sistema de Permissões.', $e);
            }
