...
class SoapClient extends \SoapClient
{
     ...
     * @return SoapResponse
     */
    private function doHttpRequest(SoapRequest $soapRequest)
    {
        // HTTP headers
...
// die;
    ...
    public function __doRequest($request, $location, $action, $version, $oneWay = 0)
    {
        ...
        $soapResponse = $this->doRequest2($soapRequest);
     ...
     * @throws \SoapFault
     */
    protected function doRequest2(SoapRequest $soapRequest)
    {
        // run SoapKernel on SoapRequest
        $this->soapKernel->filterRequest($soapRequest);

        // perform HTTP request with cURL
        $soapResponse = $this->doHttpRequest($soapRequest);
    ...
    */
     ...
     *
     * @return string
     * @throws \SoapFault|\ErrorException
     */
