    ...
    public function render()
    {
        ...
        if ($this->hasMaisDeUmaPagina()) {
            ...
            if ($numPaginas > 2) {
                ...
                $ret .= '<select id="sel' . $strSelecao . 'Paginacao' . $strTipo . '" name="sel' . $strSelecao . 'Paginacao' . $strTipo . '" onchange="infraAcaoPaginar(\'=\',this.value,\'' . $strSelecao . '\', ' . $strCustomCallbackJs . ');" class="infraSelect"' . $strTabIndex . ' aria-label="Escolher Página" style="display:inline;">' . "\n";
