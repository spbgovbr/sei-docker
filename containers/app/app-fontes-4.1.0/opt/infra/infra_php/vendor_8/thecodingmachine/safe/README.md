...
```yml
includes:
    - vendor_57/thecodingmachine/phpstan-safe-rule/phpstan-safe-rule.neon
```
...
```bash
vendor_57/bin/rector process src/ --config vendor_57/thecodingmachine/safe/rector-migrate-0.7.php
```
