...
class PHPExcel_Calculation_TextData {
	...
	private static function _uniord($c) {
		...
		if ($ascii >= 192 && $ascii <= 223)
			return ($ascii - 192) * 64 + (ord($c[1]) - 128);
		if ($ascii >= 224 && $ascii <= 239)
			return ($ascii - 224) * 4096 + (ord($c[1]) - 128) * 64 + (ord($c[2]) - 128);
		if ($ascii >= 240 && $ascii <= 247)
			return ($ascii - 240) * 262144 + (ord($c[1]) - 128) * 4096 + (ord($c[2]) - 128) * 64 + (ord($c[3]) - 128);
		if ($ascii >= 248 && $ascii <= 251)
			return ($ascii - 248) * 16777216 + (ord($c[1]) - 128) * 262144 + (ord($c[2]) - 128) * 4096 + (ord($c[3]) - 128) * 64 + (ord($c[4]) - 128);
		if ($ascii >= 252 && $ascii <= 253)
			return ($ascii - 252) * 1073741824 + (ord($c[1]) - 128) * 16777216 + (ord($c[2]) - 128) * 262144 + (ord($c[3]) - 128) * 4096 + (ord($c[4]) - 128) * 64 + (ord($c[5]) - 128);
		if ($ascii >= 254 && $ascii <= 255) //error
