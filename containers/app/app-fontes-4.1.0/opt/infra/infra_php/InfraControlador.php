    ...
    public static function processar(
        ...
        switch ($strAcao) {
            ...
            case 'infra_captcha_listar':
                require_once dirname(__FILE__) . '/formularios/infra_captcha_lista.php';
                return true;

            case 'infra_acessibilidade_exibir':
                require_once dirname(__FILE__) . '/formularios/infra_acessibidade.php';
                return true;
