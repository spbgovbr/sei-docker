...
?>
    <form id="frmInfraGerarPlanilha" method="post" onsubmit="return true;"
        ...
        ?>
        <label id="lblInfraPlanilha" for="txtInfraPlanilha" accesskey="" class="infraLabelObrigatorio">Planilha gerada
            com sucesso.</label>
