...
class InfraAuditoriaRN extends InfraRN
{
    ...
    private function validarNumIdOrgaoUsuario(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
    ...
    private function validarStrSiglaOrgaoUsuario(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
        if (InfraString::isBolVazia($objInfraAuditoriaDTO->getStrSiglaOrgaoUsuario())) {
            ...
            if (strlen($objInfraAuditoriaDTO->getStrSiglaOrgaoUsuario()) > 30) {
                $objInfraException->adicionarValidacao(
                    'Sigla do órgão do usuário possui tamanho superior a 30 caracteres.'
                );
            }
        }
    }

    private function validarNumIdUsuarioEmulador(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
    ...
    private function validarStrSiglaUsuarioEmulador(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
        if (InfraString::isBolVazia($objInfraAuditoriaDTO->getStrSiglaUsuarioEmulador())) {
            ...
            $objInfraAuditoriaDTO->setStrSiglaUsuarioEmulador(
                trim($objInfraAuditoriaDTO->getStrSiglaUsuarioEmulador())
            );

            if (strlen($objInfraAuditoriaDTO->getStrSiglaUsuarioEmulador()) > 100) {
                $objInfraException->adicionarValidacao(
                    'Sigla do usuário emulador possui tamanho superior a 100 caracteres.'
                );
            }
        }
    }

    private function validarStrNomeUsuarioEmulador(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
        if (InfraString::isBolVazia($objInfraAuditoriaDTO->getStrNomeUsuarioEmulador())) {
            ...
            if (strlen($objInfraAuditoriaDTO->getStrNomeUsuarioEmulador()) > 100) {
                $objInfraException->adicionarValidacao(
                    'Nome do usuário emulador possui tamanho superior a 100 caracteres.'
                );
            }
        }
    }

    private function validarNumIdOrgaoUsuarioEmulador(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
    ...
    private function validarStrSiglaOrgaoUsuarioEmulador(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
        if (InfraString::isBolVazia($objInfraAuditoriaDTO->getStrSiglaOrgaoUsuarioEmulador())) {
            ...
            $objInfraAuditoriaDTO->setStrSiglaOrgaoUsuarioEmulador(
                trim($objInfraAuditoriaDTO->getStrSiglaOrgaoUsuarioEmulador())
            );

            if (strlen($objInfraAuditoriaDTO->getStrSiglaOrgaoUsuarioEmulador()) > 30) {
                $objInfraException->adicionarValidacao(
                    'Sigla do órgão do usuário emulador possui tamanho superior a 30 caracteres.'
                );
            }
        }
    }
    ...
    private function validarStrDescricaoUnidade(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
        if (InfraString::isBolVazia($objInfraAuditoriaDTO->getStrDescricaoUnidade())) {
            ...
            if (strlen($objInfraAuditoriaDTO->getStrDescricaoUnidade()) > 250) {
                $objInfraException->adicionarValidacao(
                    'Descrição da unidade possui tamanho superior a 250 caracteres.'
                );
            }
        }
    }

    private function validarNumIdOrgaoUnidade(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
    ...
    private function validarStrSiglaOrgaoUnidade(
        InfraAuditoriaDTO $objInfraAuditoriaDTO,
        InfraException $objInfraException
    ) {
        if (InfraString::isBolVazia($objInfraAuditoriaDTO->getStrSiglaOrgaoUnidade())) {
            ...
            if (strlen($objInfraAuditoriaDTO->getStrSiglaOrgaoUnidade()) > 30) {
                $objInfraException->adicionarValidacao(
                    'Sigla do órgão da unidade possui tamanho superior a 30 caracteres.'
                );
            }
        }
    }
        ...
        try {
            ...
            if ($objInfraAuditoriaDTO->isSetDthInicial() || $objInfraAuditoriaDTO->isSetDthFinal()) {
                ...
                if (InfraData::compararDatas(
                        $objInfraAuditoriaDTO->getDthInicial(),
                        $objInfraAuditoriaDTO->getDthFinal()
                    ) < 0) {
            ...
            if ($objInfraAuditoriaDTO->isSetNumIdUsuario()) {
                $objInfraAuditoriaDTO->setNumIdUsuario($objInfraAuditoriaDTO->getNumIdUsuario());
            }

            if ($objInfraAuditoriaDTO->isSetStrSiglaUsuario()) {
                $objInfraAuditoriaDTO->setStrSiglaUsuario($objInfraAuditoriaDTO->getStrSiglaUsuario());
            }

            if ($objInfraAuditoriaDTO->isSetStrNomeUsuario()) {
                $objInfraAuditoriaDTO->setStrNomeUsuario(
            ...
            if ($objInfraAuditoriaDTO->isSetNumIdUnidade()) {
                $objInfraAuditoriaDTO->setNumIdUnidade($objInfraAuditoriaDTO->getNumIdUnidade());
            }

            if ($objInfraAuditoriaDTO->isSetStrSiglaUnidade()) {
                $objInfraAuditoriaDTO->setStrSiglaUnidade($objInfraAuditoriaDTO->getStrSiglaUnidade());
            }

            if ($objInfraAuditoriaDTO->isSetStrDescricaoUnidade()) {
                $objInfraAuditoriaDTO->setStrDescricaoUnidade(
            ...
            if ($objInfraAuditoriaDTO->isSetStrServidor()) {
                $objInfraAuditoriaDTO->setStrServidor(
                    '%' . $objInfraAuditoriaDTO->getStrServidor() . '%',
                    InfraDTO::$OPER_LIKE
                );
            }

            if ($objInfraAuditoriaDTO->isSetStrRecurso()) {
                $objInfraAuditoriaDTO->setStrRecurso($objInfraAuditoriaDTO->getStrRecurso());
            }
