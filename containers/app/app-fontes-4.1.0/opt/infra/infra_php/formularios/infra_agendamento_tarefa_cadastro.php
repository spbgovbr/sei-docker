...
?>
    <form id="frmInfraAgendamentoTarefaCadastro" method="post" onsubmit="return OnSubmitForm();"
        ...
        <img id="imgAjudaParametro" src="<?= PaginaInfra::getInstance()->getIconeInformacao() ?>" alt=""
             onmouseover="return infraTooltipMostrar('<?= $strAjudaParametros ?>', 'Parâmetros');"
        ...
        <label id="lblStaPeriodicidadeExecucao" for="selStaPeriodicidadeExecucao" accesskey=""
               class="infraLabelObrigatorio">Periodicidade de Execução:</label>
        ...
        <label id="lblEmailErro" for="txtEmailErro" accesskey="" class="infraLabelOpcional">Email de Erro (separar
            múltiplos endereços por ponto e vírgula):</label>
        ...
        <label id="lblUltimaExecucao" for="txtUltimaExecucao" accesskey="" class="infraLabelOpcional">Data/Hora Última
            Execução:</label>
        ...
        <label id="lblUltimaConclusao" for="txtUltimaConclusao" accesskey="" class="infraLabelOpcional">Data/Hora Última
            Conclusão:</label>
