...
class PHPMailer
{
    ...
    protected $bad_rcp = array();

    public function getArrBadReceipt(){
      return $this->bad_rcp;
    }
    ...
    protected function smtpSend($header, $body)
    {
        ...
        foreach ([$this->to, $this->cc, $this->bcc] as $togroup) {
            foreach ($togroup as $to) {
                if (!$this->smtp->recipient($to[0], $this->dsn)) {
                    ...
                    $this->bad_rcp[] = ['to' => $to[0], 'error' => $error['detail']];
                    $isSent = false;
                } else {
                    $isSent = true;
                }
        ...
        if ((count($this->all_recipients) > count($this->bad_rcp)) && !$this->smtp->data($header . $body)) {
        ...
        if (count($this->bad_rcp) > 0) {
            $errstr = '';
            foreach ($this->bad_rcp as $bad) {
