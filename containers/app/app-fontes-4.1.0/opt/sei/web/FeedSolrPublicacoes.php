...
class FeedSolrPublicacoes extends InfraSolrFeed {
    ...
    return ConfiguracaoSEI::getInstance()->getValor('Solr','CorePublicacoes');	  
	}
  ...
  public function getCommitWithin(){
    return ConfiguracaoSEI::getInstance()->getValor('Solr', 'TempoCommitPublicacoes', false, 60) * 1000;
  }
}
?>