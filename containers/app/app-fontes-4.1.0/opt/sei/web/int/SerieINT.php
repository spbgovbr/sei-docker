...
class SerieINT extends InfraINT {
  ...
  public static function montarSelectNomeUnico($numIdSerie){
    ...
    return parent::montarSelectArrInfraDTO(null, null, null, $arrObjSerieDTO, 'IdSerie', 'Nome');
  }
  ...
  public static function montarSelectNomeRI0802($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado, $numIdGrupoSerie='', $strStaNumeracao=''){
    $objSerieDTO = new SerieDTO();
    $objSerieDTO->retNumIdSerie();
    $objSerieDTO->retStrNome();
    $objSerieDTO->setOrdStrNome(InfraDTO::$TIPO_ORDENACAO_ASC);
  ...
  public static function montarSelectStaNumeracaoLista($strPrimeiroItemValor, $strPrimeiroItemDescricao, $strValorItemSelecionado){
    $objSerieRN = new SerieRN();
    $arr = $objSerieRN->listarTiposNumeracaoRN0795();

    $arrObjTipoDTO = array();
    foreach($arr as $dto){
      if ($dto->getStrStaTipo()!=SerieRN::$TN_INFORMADA && $dto->getStrStaTipo()!=SerieRN::$TN_SEM_NUMERACAO){
        $arrObjTipoDTO[] = $dto;
      }
    }
