...
class EstatisticasINT extends InfraINT {
  ...
  public static function montarGrafico($strGrafico, $strConteudo, $bolMontarBotaoVisualizacao = true ){
      ...
      echo '<button type="button" id="btnVer'.$strGrafico.'" onclick="seiExibirOcultarGrafico(\''.$strGrafico.'\')" class="infraButton infraNaoImprimir" style="display:none;width:13em;">';
      ...
      echo '<button type="button" id="btnOcultar'.$strGrafico.'" onclick="seiExibirOcultarGrafico(\''.$strGrafico.'\')" class="infraButton infraNaoImprimir" style="width:13em;">';
  ...
  public static function montarSelectTipoInspecao($strValorItemSelecionado){
    ...
    $arr[EstatisticasRN::$TIPO_INSPECAO_TIPOS_TRAMITACAO] = EstatisticasRN::$TITULO_INSPECAO_TIPOS_TRAMITACAO;
