...
try {
  ...
  if ($numRegistros > 0){
    ...
    $strResultado .= '<th class="infraTh" width="14%" rowspan="2">Utilização</th>'."\n";
      ...
      $strResultado .= '</td>';
			...
			switch($objAtividadeDTO->getNumIdTarefa()){
				case TarefaRN::$TI_CONCESSAO_CREDENCIAL_ASSINATURA:
					$strSituacao .= '<td align="center">'.substr($objAtividadeDTO->getDthAbertura(),0,16).'</td>';
					$strSituacao .= '<td>&nbsp;</td>';
					$strSituacao .= '<td>&nbsp;</td>';
					break;
