...
#selDestinatarios {position:absolute;left:0%;top:22%;width:90%;}
#divOpcoesDestinatarios {position:absolute;left:91%;top:22%;}

#divBloco {height:5em}
#lblBloco {position:absolute;left:0%;top:0%;}
#selBloco {position:absolute;left:0%;top:40%;width:60%;}
#btnNovoAssinatura {position:absolute;left:61%;top:40%;}
...
function inicializar(){
  ...
  objLupaDestinatarios.processarAlteracao = function (pos, texto, valor){
    seiCadastroContato(valor, 'selDestinatarios', 'frmDocumentoGeracaoCircular','<?=$strLinkAlterarContato?>');
  }
...
?>
  ...
  <div id="divDestinatarios" class="infraAreaDados">
    ...
    <select id="selDestinatarios" name="selDestinatarios" class="infraSelect" size="9" multiple="multiple" tabindex="<?=PaginaSEI::getInstance()->getProxTabDados()?>"  >
