...
function inicializar(){
  ...
  var arrGraficos=window.parent.arrGraficos;
  ...
  grafico.div=div;
  grafico.arrEixoXRotulos=window.parent.arrEixo;
  grafico.exibir();
  var tabela=$(window.parent.document.getElementById('divTabelas')).find('.infraTable').eq(k);
  grafico.arrLinks=[];
