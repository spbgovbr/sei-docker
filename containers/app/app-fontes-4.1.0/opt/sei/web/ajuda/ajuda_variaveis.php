...
try {
  ...
  switch($_GET['acao']){
    ...
    case 'ajuda_variaveis_secao_modelo':
      ...
      $arrVariaveis[] = array('@artigo_orgao_minuscula@','Artigo em letra minúscula associado com o órgão da unidade atual');
      $arrVariaveis[] = array('@artigo_orgao_maiuscula@','Artigo em letra maiúscula associado com o órgão da unidade atual');
      $arrVariaveis[] = array('@cnpj_orgao@','CNPJ do órgão associado com a unidade atual');
      $arrVariaveis[] = array('@endereco_orgao@','Endereço do órgão associado com a unidade atual');
      $arrVariaveis[] = array('@complemento_endereco_orgao@','Complemento do endereço do órgão associado com a unidade atual');
      $arrVariaveis[] = array('@hifen_bairro_orgao@','Caractere hífen seguido do bairro do órgão associado com a unidade atual');
      $arrVariaveis[] = array('@cidade_orgao@','Cidade do órgão associado com a unidade atual');
      $arrVariaveis[] = array('@sigla_uf_orgao@','Sigla da unidade federativa associada com o órgão da unidade atual');
      $arrVariaveis[] = array('@cep_orgao@','CEP do órgão associado com a unidade atual');
      ...
      $arrVariaveis[] = array('@email_unidade[_2,_3]@','1º, 2º ou 3º endereço eletrônico da unidade atual');
      ...
      $arrVariaveis[] = array('@nome_destinatario[_2,_3]@','Nome do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@nome_destinatario_maiusculas[_2,_3]@','Nome em letras maiúsculas do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@tratamento_destinatario[_2,_3]@','Tratamento associado com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@categoria_destinatario[_2,_3]@','Categoria associada com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@cargo_destinatario[_2,_3]@','Cargo associado com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@titulo_destinatario[_2,_3]@','Título associado com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@titulo_abreviatura_destinatario[_2,_3]@','Abreviatura do Título associada com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@funcao_destinatario[_2,_3]@','Função associada com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@vocativo_destinatario[_2,_3]@','Vocativo associado com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@artigo_destinatario_minuscula[_2,_3]@','Artigo em letra minúscula associado com o sexo do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@artigo_destinatario_maiuscula[_2,_3]@','Artigo em letra maiúscula associado com o sexo do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@cpf_destinatario[_2,_3]@','Número do CPF do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@numero_passaporte_destinatario[_2,_3]@','Número do passaporte associado com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@pais_passaporte_destinatario[_2,_3]@','País de emissão do passaporte do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@rg_destinatario[_2,_3]@','Número do RG do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@orgao_expedidor_rg_destinatario[_2,_3]@','Órgão Expedidor associado com o RG do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@matricula_destinatario[_2,_3]@','Número de matrícula do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@matricula_oab_destinatario[_2,_3]@','Número de matrícula da OAB do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@cnpj_destinatario[_2,_3]@','Número do CNPJ do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@endereco_destinatario[_2,_3]@','Endereço do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@complemento_endereco_destinatario[_2,_3]@','Complemento do endereço do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@bairro_destinatario[_2,_3]@','Bairro do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@cep_destinatario[_2,_3]@','CEP do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@cidade_destinatario[_2,_3]@','Cidade do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@sigla_uf_destinatario[_2,_3]@','Sigla da unidade federativa do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@hifen_uf_destinatario[_2,_3]@','Caractere hífen seguido da sigla da unidade federativa do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@pais_destinatario[_2,_3]@','País do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@email_destinatario[_2,_3]@','Endereço eletrônico do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@sitio_internet_destinatario[_2,_3]@','Sítio na internet do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@telefone_comercial_destinatario[_2,_3]@','Telefone comercial do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@telefone_residencial_destinatario[_2,_3]@','Telefone residencial do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@telefone_celular_destinatario[_2,_3]@','Telefone celular do 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@nome_pessoa_juridica_associada_destinatario[_2,_3]@','Nome da pessoa jurídica associada com o 1º, 2º ou 3º destinatário');
      $arrVariaveis[] = array('@cnpj_pessoa_juridica_associada_destinatario[_2,_3]@','CNPJ da pessoa jurídica associada com o 1º, 2º ou 3º destinatário');
      ...
      $arrVariaveis[] = array('@nome_interessado[_2,_3]@','Nome do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@nome_interessado_maiusculas[_2,_3]@','Nome em letras maiúsculas do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@tratamento_interessado[_2,_3]@','Tratamento associado com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@categoria_interessado[_2,_3]@','Categoria associada com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@cargo_interessado[_2,_3]@','Cargo associado com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@titulo_interessado[_2,_3]@','Título associado com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@titulo_abreviatura_interessado[_2,_3]@','Abreviatura do Título associada com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@funcao_interessado[_2,_3]@','Função associada com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@vocativo_interessado[_2,_3]@','Vocativo associado com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@artigo_interessado_minuscula[_2,_3]@','Artigo em letra minúscula associado com o sexo do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@artigo_interessado_maiuscula[_2,_3]@','Artigo em letra maiúscula associado com o sexo do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@cpf_interessado[_2,_3]@','Número do CPF do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@numero_passaporte_interessado[_2,_3]@','Número do passaporte associado com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@pais_passaporte_interessado[_2,_3]@','País de emissão do passaporte do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@rg_interessado[_2,_3]@','Número do RG do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@orgao_expedidor_rg_interessado[_2,_3]@','Órgão Expedidor associado com o RG do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@matricula_interessado[_2,_3]@','Número de matrícula do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@matricula_oab_interessado[_2,_3]@','Número de matrícula da OAB do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@cnpj_interessado[_2,_3]@','Número do CNPJ do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@endereco_interessado[_2,_3]@','Endereço do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@complemento_endereco_interessado[_2,_3]@','Complemento do endereço do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@bairro_interessado[_2,_3]@','Bairro do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@cep_interessado[_2,_3]@','CEP do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@cidade_interessado[_2,_3]@','Cidade do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@sigla_uf_interessado[_2,_3]@','Sigla da unidade federativa do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@hifen_uf_interessado[_2,_3]@','Caractere hífen seguido da sigla da unidade federativa do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@pais_interessado[_2,_3]@','País do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@email_interessado[_2,_3]@','Endereço eletrônico do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@sitio_internet_interessado[_2,_3]@','Sítio na internet do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@telefone_comercial_interessado[_2,_3]@','Telefone comercial do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@telefone_residencial_interessado[_2,_3]@','Telefone residencial do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@telefone_celular_interessado[_2,_3]@','Telefone celular do 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@nome_pessoa_juridica_associada_interessado[_2,_3]@','Nome da pessoa jurídica associada com o 1º, 2º ou 3º interessado');
      $arrVariaveis[] = array('@cnpj_pessoa_juridica_associada_interessado[_2,_3]@','CNPJ da pessoa jurídica associada com o 1º, 2º ou 3º interessado');

      $arrVariaveis[] = array('@sigla_usuario@','Sigla do usuário logado');
      $arrVariaveis[] = array('@nome_usuario@','Nome do usuário logado');
      $arrVariaveis[] = array('@cargo_usuario@','Cargo do usuário logado');
      $arrVariaveis[] = array('@email_usuario@','Endereço Eletrônico do usuário logado');
