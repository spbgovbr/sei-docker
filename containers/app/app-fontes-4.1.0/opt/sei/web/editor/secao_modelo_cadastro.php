...
try {
  ...
  $objEditorDTO->setNumTamanhoEditor(500);
...
#lblEstiloPadrao {position:absolute;left:0%;top:65%;width:50%;}
#selEstiloPadrao {position:absolute;left:0%;top:77%;width:50%;}
<?
...
function exibirAjuda(){
  infraAbrirJanelaModal('<?=SessaoSEI::getInstance()->assinarLink('controlador.php?acao=ajuda_variaveis_secao_modelo')?>',800,600);
}
