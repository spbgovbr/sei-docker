...
try {
  ...
  if(SessaoSEI::getInstance()->verificarPermissao('editor_simular')){
    $arrComandos[] = '<button type="button" accesskey="V" id="btnVisualizar" value="Visualizar" onclick="infraAbrirJanelaModal(\''.SessaoSEI::getInstance()->assinarLink('controlador.php?acao=editor_simular&acao_origem='.$_GET['acao'].'&acao_retorno='.$_GET['acao'].$strParametros).'\',800,600);" class="infraButton"><span class="infraTeclaAtalho">V</span>isualizar Modelo</button>';
  }
