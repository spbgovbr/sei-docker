...
class SeiWS extends SeiUtilWS {

  public function getObjInfraLog() {
    return LogSEI::getInstance();
  }

  protected function gerarProcedimentoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $Procedimento, $Documentos, $ProcedimentosRelacionados, $UnidadesEnvio, $SinManterAbertoUnidade, $SinEnviarEmailNotificacao, $DataRetornoProgramado, $DiasRetornoProgramado,
    $SinDiasUteisRetornoProgramado, $IdMarcador, $TextoMarcador, $DataControlePrazo, $DiasControlePrazo, $SinDiasUteisControlePrazo) {
    try {
      if ($Documentos != null) {
  ...
  protected function consultarProcedimentoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento, $SinRetornarAssuntos, $SinRetornarInteressados, $SinRetornarObservacoes, $SinRetornarAndamentoGeracao, $SinRetornarAndamentoConclusao,
    $SinRetornarUltimoAndamento, $SinRetornarUnidadesProcedimentoAberto, $SinRetornarProcedimentosRelacionados, $SinRetornarProcedimentosAnexados) {
    try {
  ...
  protected function consultarProcedimentoIndividualMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdOrgaoProcedimento, $IdTipoProcedimento, $IdOrgaoUsuario, $SiglaUsuario) {
    try {
  ...
  protected function consultarDocumentoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloDocumento, $SinRetornarAndamentoGeracao, $SinRetornarAssinaturas, $SinRetornarPublicacao, $SinRetornarCampos, $SinRetornarBlocos) {
    try {
      ...
      $objEntradaConsultarDocumentoAPI->setSinRetornarBlocos($SinRetornarBlocos);
  ...
  protected function enviarProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento, $UnidadesDestino, $SinManterAbertoUnidade, $SinRemoverAnotacao, $SinEnviarEmailNotificacao, $DataRetornoProgramado, $DiasRetornoProgramado,
  ...
  protected function lancarAndamentoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento, $IdTarefa, $IdTarefaModulo, $Atributos) {
    try {
  ...
  protected function listarAndamentosMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento, $SinRetornarAtributos, $Andamentos, $Tarefas, $TarefasModulos) {
    try {
  ...
  protected function cancelarDocumentoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloDocumento, $Motivo) {
    try {
  ...
  protected function bloquearDocumentoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloDocumento) {
    try {
  ...
  protected function gerarBlocoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $Tipo, $Descricao, $UnidadesDisponibilizacao, $Documentos, $SinDisponibilizar) {
    try {
  ...
  protected function consultarBlocoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdBloco, $SinRetornarProtocolos) {
    try {
  ...
  protected function excluirProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento) {
    try {
  ...
  protected function cancelarDisponibilizacaoBlocoMonitorado(
  ...
  protected function concluirBlocoMonitorado($SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdBloco) {
    try {
      $objEntradaConcluirBlocoAPI = new EntradaConcluirBlocoAPI();
      $objEntradaConcluirBlocoAPI->setIdBloco($IdBloco);
      ...
      throw new InfraException('Erro no serviço de conclusão de bloco.', $e);
    }
  }

  protected function reabrirBlocoMonitorado($SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdBloco) {
    try {
      $objEntradaReabrirBlocoAPI = new EntradaReabrirBlocoAPI();
      $objEntradaReabrirBlocoAPI->setIdBloco($IdBloco);
      ...
      throw new InfraException('Erro no serviço de reabertura de bloco.', $e);
    }
  }

  protected function devolverBlocoMonitorado($SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdBloco) {
    try {
      $objEntradaDevolverBlocoAPI = new EntradaDevolverBlocoAPI();
      $objEntradaDevolverBlocoAPI->setIdBloco($IdBloco);
      ...
      throw new InfraException('Erro no serviço de devolução de bloco.', $e);
    }
  }

  protected function incluirDocumentoBlocoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdBloco, $ProtocoloDocumento, $Anotacao) {
    try {
  ...
  protected function retirarDocumentoBlocoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdBloco, $ProtocoloDocumento) {
    try {
  ...
  protected function incluirProcessoBlocoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdBloco, $ProtocoloProcedimento, $Anotacao) {
    try {
  ...
  protected function retirarProcessoBlocoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdBloco, $ProtocoloProcedimento) {
    try {
  ...
  protected function reabrirProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento) {
    try {
  ...
  protected function concluirProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento) {
    try {
  ...
  protected function atribuirProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento, $IdUsuario, $SinReabrir) {
    try {
  ...
  protected function bloquearProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento) {
    try {
  ...
  protected function desbloquearProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento) {
    try {
  ...
  protected function relacionarProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento1, $ProtocoloProcedimento2) {
    try {
  ...
  protected function removerRelacionamentoProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento1, $ProtocoloProcedimento2) {
    try {
  ...
  protected function sobrestarProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento, $ProtocoloProcedimentoVinculado, $Motivo) {
    try {
  ...
  protected function removerSobrestamentoProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento) {
    try {
  ...
  protected function anexarProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimentoPrincipal, $ProtocoloProcedimentoAnexado) {
    try {
  ...
  protected function desanexarProcessoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimentoPrincipal, $ProtocoloProcedimentoAnexado, $Motivo) {
    try {
  ...
  protected function concluirControlePrazoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocolosProcedimento) {
    try {
  ...
  protected function removerControlePrazoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocolosProcedimento) {
    try {
  ...
  protected function registrarAnotacaoMonitorado($SiglaSistema, $IdentificacaoServico, $IdUnidade, $Anotacoes) {
    try {
      ...
      if ($Anotacoes != null) {
        foreach ($Anotacoes as $Anotacao) {
          ...
          $objEntradaRegistrarAnotacaoAPI->setProtocoloProcedimento($Anotacao->ProtocoloProcedimento);
          //$objEntradaRegistrarAnotacaoAPI->setIdProcedimento();
          $objEntradaRegistrarAnotacaoAPI->setDescricao($Anotacao->Descricao);
          $objEntradaRegistrarAnotacaoAPI->setSinPrioridade($Anotacao->SinPrioridade);
      ...
      throw new InfraException('Erro no serviço de registro de anotação.', $e);
    }
  }

  protected function listarAndamentosMarcadoresMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento, $Marcadores) {
    try {
  ...
  protected function listarExtensoesPermitidasMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdArquivoExtensao) {
    try {
  ...
  protected function listarTiposPrioridadeMonitorado($SiglaSistema, $IdentificacaoServico, $IdUnidade) {
    try {
      $objSeiRN = new SeiRN();
      return $objSeiRN->listarTiposPrioridade();
    } catch (Throwable $e) {
      throw new InfraException('Erro no serviço de listagem de tipos de prioridade.', $e);
    }
  }
  ...
  protected function listarContatosMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdTipoContato, $PaginaRegistros, $PaginaAtual, $Sigla, $Nome, $Cpf, $Cnpj, $Matricula, $IdContatos) {
    try {
  ...
  protected function adicionarArquivoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $Nome, $Tamanho, $Hash, $Conteudo) {
    try {
  ...
  protected function adicionarConteudoArquivoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdArquivo, $Conteudo) {
    try {
  ...
  protected function registrarOuvidoriaMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdOrgao, $Nome, $NomeSocial, $Email, $Cpf, $Rg, $OrgaoExpedidor, $Telefone, $Estado, $Cidade, $IdTipoProcedimento, $Processos, $SinRetorno, $Mensagem, $AtributosAdicionais) {
    try {
  ...
  protected function listarFeriadosMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdOrgao, $DataInicial, $DataFinal) {
    try {
  ...
  protected function consultarPublicacaoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdPublicacao, $IdDocumento, $ProtocoloDocumento, $SinRetornarAndamento, $SinRetornarAssinaturas) {
    try {
  ...
  protected function agendarPublicacaoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdDocumento, $ProtocoloDocumento, $StaMotivo, $IdVeiculoPublicacao, $DataDisponibilizacao, $Resumo, $ImprensaNacional) {
    try {
  ...
  protected function alterarPublicacaoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdPublicacao, $IdDocumento, $ProtocoloDocumento, $StaMotivo, $IdVeiculoPublicacao, $DataDisponibilizacao, $Resumo, $ImprensaNacional) {
    try {
  ...
  protected function cancelarAgendamentoPublicacaoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdPublicacao, $IdDocumento, $ProtocoloDocumento) {
    try {
  ...
  protected function confirmarDisponibilizacaoPublicacaoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdVeiculoPublicacao, $DataDisponibilizacao, $DataPublicacao, $Numero, $IdDocumentos) {
    try {
  ...
  protected function enviarEmailMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $ProtocoloProcedimento, $De, $Para, $CCO, $Assunto, $Mensagem, $IdDocumentos) {
    try {
  ...
  protected function listarUnidadesMonitorado($SiglaSistema, $IdentificacaoServico, $IdTipoProcedimento, $IdSerie) {
    try {
      ...
      if (!InfraString::isBolVazia($IdTipoProcedimento)) {
        $objOperacaoServicoDTO->adicionarCriterio(array('IdTipoProcedimento', 'IdTipoProcedimento'), array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL), array($IdTipoProcedimento, null), InfraDTO::$OPER_LOGICO_OR);
      }

      if (!InfraString::isBolVazia($IdSerie)) {
        $objOperacaoServicoDTO->adicionarCriterio(array('IdSerie', 'IdSerie'), array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL), array($IdSerie, null), InfraDTO::$OPER_LOGICO_OR);
      }
  ...
  protected function listarTiposProcedimentoMonitorado(
    $SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdSerie, $SinIndividual) {
    try {
      $objOperacaoServicoRN = new OperacaoServicoRN();
      ...
      if (!InfraString::isBolVazia($IdUnidade)) {
        $objOperacaoServicoDTO->adicionarCriterio(array('IdUnidade', 'IdUnidade'), array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL), array($IdUnidade, null), InfraDTO::$OPER_LOGICO_OR);
      }
      ...
      if (count($arrObjOperacaoServicoDTO)) {
        ...
        if (!InfraString::isBolVazia($SinIndividual)) {
          if (!InfraUtil::isBolSinalizadorValido($SinIndividual)) {
            throw new InfraException('Sinalizador para filtro de tipo de processo individual inválido.');
          }
          $objTipoProcedimentoDTO->setStrSinIndividual($SinIndividual);
        }
  ...
  protected function listarSeriesMonitorado($SiglaSistema, $IdentificacaoServico, $IdUnidade, $IdTipoProcedimento) {
    try {
      ...
      if (count($arrObjOperacaoServicoDTO)) {
        ...
        if (!$bolFlagTodas) {
          if (count($arrIdSerie)) {
            $objSerieDTO->adicionarCriterio(array('IdSerie', 'StaAplicabilidade'), array(InfraDTO::$OPER_IN, InfraDTO::$OPER_DIFERENTE), array($arrIdSerie, 'I'), InfraDTO::$OPER_LOGICO_OR);
          }
        } else {
          if (count($arrTiposNaoLiberados)) {
            $objSerieDTO->adicionarCriterio(array('IdSerie', 'StaAplicabilidade'), array(InfraDTO::$OPER_NOT_IN, InfraDTO::$OPER_DIFERENTE), array($arrTiposNaoLiberados, 'I'), InfraDTO::$OPER_LOGICO_OR);
          }
        }
  ...
  private function montarProcedimentoAPI($Procedimento) {
    ...
    $objProcedimentoAPI->setIdTipoPrioridade($Procedimento->IdTipoPrioridade);
    ...
    if (is_array($Procedimento->Interessados)) {
      ...
      for ($i = 0; $i < $numInteressados; $i++) {
        ...
        $objInteressadoAPI->setIdContato($Procedimento->Interessados[$i]->IdContato);
        $objInteressadoAPI->setCpf($Procedimento->Interessados[$i]->Cpf);
        $objInteressadoAPI->setCnpj($Procedimento->Interessados[$i]->Cnpj);
  ...
  private function montarDocumentoAPI($Documento) {
    ...
    $objDocumentoAPI->setDinValor($Documento->DinValor);
    ...
    if ($Documento->Remetente != null) {
      if (isset($Documento->Remetente->IdContato) || isset($Documento->Remetente->Cpf) || isset($Documento->Remetente->Cnpj) || isset($Documento->Remetente->Sigla) || isset($Documento->Remetente->Nome)) {
        $objRemetenteAPI = new RemetenteAPI();

        if (isset($Documento->Remetente->IdContato)) {
          $objRemetenteAPI->setIdContato($Documento->Remetente->IdContato);
        } else {
          $objRemetenteAPI->setIdContato(null);
        }

        if (isset($Documento->Remetente->Cpf)) {
          $objRemetenteAPI->setCpf($Documento->Remetente->Cpf);
        } else {
          $objRemetenteAPI->setCpf(null);
        }

        if (isset($Documento->Remetente->Cnpj)) {
          $objRemetenteAPI->setCnpj($Documento->Remetente->Cnpj);
        } else {
          $objRemetenteAPI->setCnpj(null);
        }
    ...
    if (is_array($Documento->Interessados)) {
      ...
      for ($i = 0; $i < $numInteressados; $i++) {
        ...
        $objInteressadoAPI = new InteressadoAPI();
        $objInteressadoAPI->setIdContato($Documento->Interessados[$i]->IdContato);
        $objInteressadoAPI->setCpf($Documento->Interessados[$i]->Cpf);
        $objInteressadoAPI->setCnpj($Documento->Interessados[$i]->Cnpj);
    ...
    if (is_array($Documento->Destinatarios)) {
      ...
      for ($i = 0; $i < $numDestinatarios; $i++) {
        ...
        $objDestinatarioAPI->setIdContato($Documento->Destinatarios[$i]->IdContato);
        $objDestinatarioAPI->setCpf($Documento->Destinatarios[$i]->Cpf);
        $objDestinatarioAPI->setCnpj($Documento->Destinatarios[$i]->Cnpj);
    ...
    $arrObjSecaoDocumentoAPI = array();

    if (is_array($Documento->ConteudoSecoes)) {
      $numSecoesDocumento = count($Documento->ConteudoSecoes);

      for ($i = 0; $i < $numSecoesDocumento; $i++) {
        if (is_array($Documento->ConteudoSecoes[$i])) {
          $Documento->ConteudoSecoes[$i] = (object)$Documento->ConteudoSecoes[$i];
        }
        $objSecaoDocumentoAPI = new SecaoDocumentoAPI();
        $objSecaoDocumentoAPI->setNome($Documento->ConteudoSecoes[$i]->Nome);
        $objSecaoDocumentoAPI->setConteudo($Documento->ConteudoSecoes[$i]->Conteudo);
        $arrObjSecaoDocumentoAPI[] = $objSecaoDocumentoAPI;
      }
    }
    $objDocumentoAPI->setConteudoSecoes($arrObjSecaoDocumentoAPI);
    ...
    $objDocumentoAPI->setIdItemEtapa($Documento->IdItemEtapa);
...
$servidorSoap = new BeSimple\SoapServer\SoapServer("sei.wsdl", array(
  'encoding' => 'ISO-8859-1', 'soap_version' => SOAP_1_1, 'attachment_type' => BeSimple\SoapCommon\Helper::ATTACHMENTS_TYPE_MTOM
));
