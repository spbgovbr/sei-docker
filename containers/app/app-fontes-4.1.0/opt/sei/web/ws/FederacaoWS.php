...
class FederacaoWS extends InfraWS
{
  ...
  public function __call($func, $params)
  {
    try {
      ...
      if (!method_exists($this, $func.'Federacao')) {
      ...
      $ret = call_user_func_array(array($this, $func.'Federacao'), $params);
  ...
  protected function solicitarRegistroFederacao($Identificacao)
  {
    try {
  ...
  protected function liberarRegistroFederacao($Identificacao)
  {
    try {
  ...
  protected function confirmarLiberacaoFederacao($Identificacao)
  {
    try {
  ...
  protected function bloquearRegistroFederacao($Identificacao)
  {
    try {
  ...
  protected function verificarConexaoFederacao($Identificacao)
  {
    try {
  ...
  protected function pesquisarOrgaosUnidadesFederacao($Identificacao, $PalavrasPesquisa, $StaTipoFiltro)
  {
    try {
      ...
      $objAcessoFederacaoDTO->setStrStaTipoFiltroUnidades($StaTipoFiltro);
      ...
      $objInstalacao->SeiVersao = $objInstalacaoFederacaoDTO->getStrSeiVersao();
      $objInstalacao->SeiFederacaoVersao = $objInstalacaoFederacaoDTO->getStrSeiFederacaoVersao();
  ...
  protected function concederAcessoFederacao($Identificacao, $Procedimento, $InstalacaoOrigem, $ProcedimentoOrigem, $Acessos, $Tipo, $Motivo, $DataHora)
  {
    try {
  ...
  protected function replicarAcessosFederacao($Identificacao, $Procedimento, $Acessos, $Instalacoes, $Orgaos, $Unidades, $Usuarios, $ProtocolosFederacao)
  {
    try {
  ...
  protected function replicarSinalizacoesFederacao($Identificacao, $Sinalizacoes)
  {
    try {
  ...
  protected function visualizarProcessoFederacao($Identificacao, $VisualizacaoProcesso)
  {
    try {
  ...
  protected function visualizarDocumentoFederacao($Identificacao, $Procedimento, $Documento)
  {
    try {
  ...
  protected function gerarPdfFederacao($Identificacao, $Procedimento, $Protocolos)
  {
    try {
  ...
  protected function gerarZipFederacao($Identificacao, $Procedimento, $Protocolos)
  {
    try {
