...
function atualizarCampos(tipo){
  ...
  switch(parseInt(tipo,10)){
    ...
    case <?=OperacaoServicoRN::$TS_CONCLUIR_BLOCO?>:
    case <?=OperacaoServicoRN::$TS_REABRIR_BLOCO?>:
    case <?=OperacaoServicoRN::$TS_DEVOLVER_BLOCO?>:
    ...
    case <?=OperacaoServicoRN::$TS_LISTAR_TIPOS_PRIORIDADE?>:
    ...
    case <?=OperacaoServicoRN::$TS_REGISTRAR_ANOTACAO?>:
