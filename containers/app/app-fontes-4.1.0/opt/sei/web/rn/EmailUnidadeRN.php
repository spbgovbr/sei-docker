...
class EmailUnidadeRN extends InfraRN
{
    ...
    private function validarNumSequencia(EmailUnidadeDTO $objEmailUnidadeDTO, InfraException $objInfraException)
    {
        if (InfraString::isBolVazia($objEmailUnidadeDTO->getNumSequencia())) {
    ...
    protected function cadastrarControlado(EmailUnidadeDTO $objEmailUnidadeDTO)
    {
        try {
            ...
            $this->validarNumSequencia($objEmailUnidadeDTO, $objInfraException);
    ...
    protected function alterarControlado(EmailUnidadeDTO $objEmailUnidadeDTO)
    {
        try {
            ...
            if ($objEmailUnidadeDTO->isSetNumSequencia()) {
                $this->validarNumSequencia($objEmailUnidadeDTO, $objInfraException);
            }
