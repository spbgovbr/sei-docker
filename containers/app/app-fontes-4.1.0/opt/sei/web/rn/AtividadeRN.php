...
class AtividadeRN extends InfraRN {
  ...
  public static $TV_REABERTURA_PROGRAMADA = 64;
  ...
  public function enviarRN0023(EnviarProcessoDTO $parObjEnviarProcessoDTO) {
    try {
      ...
      if ($this->enviarRN0023Interno($parObjEnviarProcessoDTO)) {
        ...
        $objIndexacaoDTO->setStrStaOperacao(IndexacaoRN::$TO_PROCESSO_COM_DOCUMENTOS_TRAMITACAO);
  ...
  protected function enviarRN0023InternoControlado(EnviarProcessoDTO $parObjEnviarProcessoDTO) {
    try {
      ...
      $this->validarAndamentosAtuais($arrIdProtocolosOrigem, $objInfraException);
      ...
      if ($parObjEnviarProcessoDTO->isSetDtaPrazoRetornoProgramado()) {
        $this->validarDtaPrazoRetornoProgramado($parObjEnviarProcessoDTO, $objInfraException);
      } else {
        $parObjEnviarProcessoDTO->setDtaPrazoRetornoProgramado(null);
      }

      if ($parObjEnviarProcessoDTO->isSetNumDiasRetornoProgramado()) {
        $this->validarNumDiasRetornoProgramado($parObjEnviarProcessoDTO, $objInfraException);
      } else {
        $parObjEnviarProcessoDTO->setNumDiasRetornoProgramado(null);
      }

      if ($parObjEnviarProcessoDTO->isSetStrSinDiasUteisRetornoProgramado()) {
        $this->validarStrSinDiasUteisRetornoProgramado($parObjEnviarProcessoDTO, $objInfraException);
      } else {
        $parObjEnviarProcessoDTO->setStrSinDiasUteisRetornoProgramado('N');
      }

      if (!InfraString::isBolVazia($parObjEnviarProcessoDTO->getDtaPrazoRetornoProgramado()) && !InfraString::isBolVazia($parObjEnviarProcessoDTO->getNumDiasRetornoProgramado())) {
      ...
      foreach ($arrObjProtocoloDTO as $objProtocoloDTO) {
        if ($objProtocoloDTO->getStrStaNivelAcessoGlobal() == ProtocoloRN::$NA_SIGILOSO) {
          $objInfraException->lancarValidacao('Processo ' . $objProtocoloDTO->getStrProtocoloFormatado() . ' não pode ser enviado.');
        }
      ...
      if ($parObjEnviarProcessoDTO->getStrSinManterAberto() == 'N') {
        foreach ($arrIdProtocolosOrigem as $dblIdProtocoloOrigem) {
          ...
          $objProcedimentoDTO->setDblIdProcedimento($dblIdProtocoloOrigem);
          $objProcedimentoDTO->setStrProtocoloProcedimentoFormatado($arrObjProtocoloDTO[$dblIdProtocoloOrigem]->getStrProtocoloFormatado());
      ...
      foreach ($arrUnidadesAtividades as $numIdUnidadeAtividade) {
        if (!in_array($numIdUnidadeAtividade, $arrUnidadesConsultadas)) {
          ...
          if ($arrObjUnidadeDTO[$numIdUnidadeAtividade]->getStrSinAtivo() == 'N') {
      ...
      foreach ($arrObjUnidadeDTO as $objUnidadeDTO) {
        if (in_array($objUnidadeDTO->getNumIdUnidade(), $arrIdUnidadesEnvio)) {
          if ($objUnidadeDTO->getStrSinEnvioProcessoOrgao() == 'N') {
            ...
            if ($objUnidadeDTO->getStrSinEnvioProcesso() == 'N') {
      ...
      if (!InfraString::isBolVazia($parObjEnviarProcessoDTO->getDtaPrazoRetornoProgramado())) {
        foreach ($arrObjAtividadeDTO as $objAtividadeDTO) {
          $objAtividadeDTO->setDtaPrazo($parObjEnviarProcessoDTO->getDtaPrazoRetornoProgramado());
        }
      } else {
        if (!InfraString::isBolVazia($parObjEnviarProcessoDTO->getNumDiasRetornoProgramado())) {
          if ($parObjEnviarProcessoDTO->getStrSinDiasUteisRetornoProgramado() == 'N') {
            $strPrazo = InfraData::calcularData($parObjEnviarProcessoDTO->getNumDiasRetornoProgramado(), InfraData::$UNIDADE_DIAS, InfraData::$SENTIDO_ADIANTE);
            ...
            $strDataFinal = InfraData::calcularData(($parObjEnviarProcessoDTO->getNumDiasRetornoProgramado() + 365), InfraData::$UNIDADE_DIAS, InfraData::$SENTIDO_ADIANTE, $strDataInicial);
            ...
            foreach ($arrIdOrgaoEnvio as $numIdOrgaoEnvio) {
              ...
              $numDias = $parObjEnviarProcessoDTO->getNumDiasRetornoProgramado();
      ...
      if ($parObjEnviarProcessoDTO->getStrSinManterAberto() == 'N') {
        ...
        if ($parObjEnviarProcessoDTO->isSetDtaPrazoReaberturaProgramada()) {
          $objReaberturaProgramadaDTO->setDtaPrazo($parObjEnviarProcessoDTO->getDtaPrazoReaberturaProgramada());
        } else {
          $objReaberturaProgramadaDTO->setDtaPrazo(null);
        }

        if ($parObjEnviarProcessoDTO->isSetNumDiasReaberturaProgramada()) {
          $objReaberturaProgramadaDTO->setNumDias($parObjEnviarProcessoDTO->getNumDiasReaberturaProgramada());
        } else {
          $objReaberturaProgramadaDTO->setNumDias(null);
        }

        if ($parObjEnviarProcessoDTO->isSetStrSinDiasUteisReaberturaProgramada()) {
          $objReaberturaProgramadaDTO->setStrSinDiasUteis($parObjEnviarProcessoDTO->getStrSinDiasUteisReaberturaProgramada());
        } else {
          $objReaberturaProgramadaDTO->setStrSinDiasUteis('N');
        }

        $objReaberturaProgramadaDTO->setDblIdProtocolo(array_keys($arrObjProtocoloDTO));
  ...
  protected function atualizarAndamentoControlado(AtualizarAndamentoDTO $objAtualizarAndamentoDTO) {
    try {
      ...
      $this->validarAndamentosAtuais(InfraArray::converterArrInfraDTO($objAtualizarAndamentoDTO->getArrObjProtocoloDTO(), 'IdProtocolo'), $objInfraException);
  ...
  protected function gerarInternaRN0727Controlado(AtividadeDTO $objAtividadeDTO) {
    try {
      ...
      if ($objAtividadeDTO->isSetNumIdTarefa()) {
        ...
        if ($objAtividadeDTO->isSetStrIdTarefaModuloTarefa()) {
      ...
      if ($objUnidadeDTO->getStrSinProtocolo() == 'S' && $objAtividadeDTO->getNumIdUnidade() != SessaoSEI::getInstance()->getNumIdUnidadeAtual() && $numIdTarefa == TarefaRN::$TI_REABERTURA_PROCESSO_UNIDADE) {
        ...
        if ($strStaNivelAcessoGlobal == ProtocoloRN::$NA_SIGILOSO) {
          if (in_array($numIdTarefa, TarefaRN::getArrTarefasConcessaoCredencial(true))) {
            ...
            if ($numIdTarefa == TarefaRN::$TI_GERACAO_PROCEDIMENTO) {
              ...
              if ($numIdTarefa == TarefaRN::$TI_REABERTURA_PROCESSO_USUARIO || $numIdTarefa == TarefaRN::$TI_PROCESSO_RENOVACAO_CREDENCIAL) {
                //atribui para o usuario "destino"
                $objAtividadeDTO->setNumIdUsuarioAtribuicao($objAtividadeDTO->getNumIdUsuario());
          ...
          if (SessaoSEI::getInstance()->isBolHabilitada()) {
            if ($bolFlagReaberturaAutomaticaProtocolo || $numIdTarefa == TarefaRN::$TI_PROCESSO_REMETIDO_UNIDADE) {
              ...
              if (/*$numIdTarefa == TarefaRN::$TI_GERACAO_PROCEDIMENTO ||*/ $numIdTarefa == TarefaRN::$TI_REABERTURA_PROCESSO_UNIDADE) {
                $objAtividadeDTO->setNumIdUsuarioAtribuicao(SessaoSEI::getInstance()->getNumIdUsuario());
              }
            }
          }
      ...
      if (!$bolFlagReaberturaAutomaticaProtocolo && $numIdTarefa != TarefaRN::$TI_REABERTURA_PROCESSO_UNIDADE && $numIdTarefa != TarefaRN::$TI_REABERTURA_PROCESSO_USUARIO && $objTarefaDTO->getStrSinFecharAndamentosAbertos() == 'S') {
        $dto = new AtividadeDTO();
      ...
      if (count($arrObjAtividadeDTO)) {
        ...
        foreach ($arrObjAtividadeDTO as $dto) {
          ...
          if ($dto->getNumIdUsuarioVisualizacao() != null && $objAtividadeDTO->getNumIdUsuarioVisualizacao() == null) { //nao foi configurado na chamada
          ...
          if ($strStaNivelAcessoGlobal == ProtocoloRN::$NA_SIGILOSO) {
            if ($numIdTarefa != TarefaRN::$TI_PROCESSO_RECEBIMENTO_CREDENCIAL && in_array($dto->getNumIdTarefa(), TarefaRN::getArrTarefasConcessaoCredencial(false))) {
              $arrReceber[] = $dto->getNumIdAtividade();
            }
          } else {
        ...
        if ($numIdTarefa == TarefaRN::$TI_PROCESSO_RECEBIMENTO_CREDENCIAL || $numIdTarefa == TarefaRN::$TI_PROCESSO_RECEBIDO_UNIDADE) {
          ...
          if ($objAtividadeDTO->getNumIdUsuarioAtribuicao() != null && $objAtividadeDTO->getNumIdUsuarioAtribuicao() != SessaoSEI::getInstance()->getNumIdUsuario() && $objInfraParametro->getValor('SEI_SINALIZACAO_PROCESSO') == '1') {
        ...
        if (count($arrReceber)) {
          if (SessaoSEI::getInstance()->isBolHabilitada()) {
            ...
            $numAtividades = count($arrObjAtividadeDTO);
            for ($i = 0; $i < $numAtividades; $i++) {
              if (in_array($arrObjAtividadeDTO[$i]->getNumIdAtividade(), $arrReceber)) {
                unset($arrObjAtividadeDTO[$i]);
              }
            }
            $arrObjAtividadeDTO = array_values($arrObjAtividadeDTO);
          }
        }
        ...
        if ($numIdTarefa == TarefaRN::$TI_REABERTURA_PROCESSO_UNIDADE || $numIdTarefa == TarefaRN::$TI_REABERTURA_PROCESSO_USUARIO) {
      ...
      if ($bolFlagReaberturaAutomaticaProtocolo || $numIdTarefa == TarefaRN::$TI_PROCESSO_REMETIDO_UNIDADE || in_array($numIdTarefa, TarefaRN::getArrTarefasConcessaoCredencial(true))) {
        $objAtividadeDTO->setNumIdUsuarioVisualizacao(null);
        ...
        if ($objTarefaDTO->getStrSinLancarAndamentoFechado() == 'S' || (!$bolFlagConcluiu && //não estava com o processo aberto na unidade
            ...
            ($objTarefaDTO->getStrSinPermiteProcessoFechado() == 'S'
              ...
              (!SessaoSEI::getInstance()->isBolHabilitada() && $objProtocoloDTO->getStrStaEstado() == ProtocoloRN::$TE_NORMAL && ($numIdTarefa == TarefaRN::$TI_GERACAO_DOCUMENTO || $numIdTarefa == TarefaRN::$TI_RECEBIMENTO_DOCUMENTO || $numIdTarefa == TarefaRN::$TI_ARQUIVO_ANEXADO))
              ...
              ($objUnidadeDTO->getStrSinProtocolo() == 'S' && $numIdTarefa != TarefaRN::$TI_GERACAO_PROCEDIMENTO && $numIdTarefa != TarefaRN::$TI_REABERTURA_PROCESSO_UNIDADE && $numIdTarefa != TarefaRN::$TI_REABERTURA_PROCESSO_USUARIO && $numIdTarefa != TarefaRN::$TI_PROCESSO_REMETIDO_UNIDADE && !in_array($numIdTarefa,
                  TarefaRN::getArrTarefasConcessaoCredencial(true)))

              ||

              ($objProtocoloDTO->getStrStaEstado() == ProtocoloRN::$TE_PROCEDIMENTO_ANEXADO && ($numIdTarefa == TarefaRN::$TI_CANCELAMENTO_DOCUMENTO || $numIdTarefa == TarefaRN::$TI_GERACAO_DOCUMENTO || $numIdTarefa == TarefaRN::$TI_ARQUIVO_ANEXADO || $numIdTarefa == TarefaRN::$TI_ENVIO_EMAIL || $numIdTarefa == TarefaRN::$TI_ALTERACAO_NIVEL_ACESSO_GLOBAL || $numIdTarefa == TarefaRN::$TI_ALTERACAO_NIVEL_ACESSO_PROCESSO || $numIdTarefa == TarefaRN::$TI_ALTERACAO_NIVEL_ACESSO_DOCUMENTO || $numIdTarefa == TarefaRN::$TI_ALTERACAO_HIPOTESE_LEGAL_PROCESSO || $numIdTarefa == TarefaRN::$TI_ALTERACAO_HIPOTESE_LEGAL_DOCUMENTO || $numIdTarefa == TarefaRN::$TI_ALTERACAO_TIPO_CONFERENCIA_DOCUMENTO)) ||
          ...
          if (!$bolFlagConcluiu && $numIdTarefa != TarefaRN::$TI_GERACAO_PROCEDIMENTO && $numIdTarefa != TarefaRN::$TI_REABERTURA_PROCESSO_UNIDADE && $numIdTarefa != TarefaRN::$TI_REABERTURA_PROCESSO_USUARIO && $numIdTarefa != TarefaRN::$TI_PROCESSO_RENOVACAO_CREDENCIAL && $numIdTarefa != TarefaRN::$TI_CANCELAMENTO_AGENDAMENTO && $numIdTarefa != TarefaRN::$TI_REMOCAO_SOBRESTANDO_PROCESSO) {
      ...
      if ($numIdTarefa == TarefaRN::$TI_ASSINATURA_DOCUMENTO || $numIdTarefa == TarefaRN::$TI_RECEBIMENTO_DOCUMENTO || $numIdTarefa == TarefaRN::$TI_DOCUMENTO_MOVIDO_DO_PROCESSO) {
        ...
        if ($bolFlagReaberturaAutomaticaProtocolo) {
          ...
          if ($numIdTarefa == TarefaRN::$TI_REMOCAO_SOBRESTAMENTO) {
  ...
  protected function validarStrSinConcluirOriginaisRN0826(
    EnviarProcessoDTO $objEnviarProcessoDTO, InfraException $objInfraException) {
  ...
  protected function validarStrSinRemoverAnotacoes(
    EnviarProcessoDTO $objEnviarProcessoDTO, InfraException $objInfraException) {
  ...
  protected function validarStrSinEnviarEmailNotificacao(
    EnviarProcessoDTO $objEnviarProcessoDTO, InfraException $objInfraException) {
  ...
  protected function validarStrSinDiasUteisRetornoProgramado(
    EnviarProcessoDTO $objEnviarProcessoDTO, InfraException $objInfraException) {
    if (InfraString::isBolVazia($objEnviarProcessoDTO->getStrSinDiasUteisRetornoProgramado())) {
      $objInfraException->adicionarValidacao('Sinalizador de dias úteis do retorno programado não informado.');
    } else {
      if (!InfraUtil::isBolSinalizadorValido($objEnviarProcessoDTO->getStrSinDiasUteisRetornoProgramado())) {
        $objInfraException->lancarValidacao('Sinalizador de dias úteis do retorno programado inválido.');
      }
    }
  }

  private function validarDtaPrazoRetornoProgramado(
    EnviarProcessoDTO $objEnviarProcessoDTO, InfraException $objInfraException) {
    if (InfraString::isBolVazia($objEnviarProcessoDTO->getDtaPrazoRetornoProgramado())) {
      $objEnviarProcessoDTO->setDtaPrazoRetornoProgramado(null);
    } else {
      if (!InfraData::validarData($objEnviarProcessoDTO->getDtaPrazoRetornoProgramado())) {
        $objInfraException->adicionarValidacao('Data do retorno programado inválida.');
      }

      if (InfraData::compararDatas(InfraData::getStrDataAtual(), $objEnviarProcessoDTO->getDtaPrazoRetornoProgramado()) < 0) {
        $objInfraException->adicionarValidacao('Data do retorno programado não pode estar no passado.');
      }
    }
  }

  private function validarNumDiasRetornoProgramado(
    EnviarProcessoDTO $objEnviarProcessoDTO, InfraException $objInfraException) {
    if (InfraString::isBolVazia($objEnviarProcessoDTO->getNumDiasRetornoProgramado())) {
      $objEnviarProcessoDTO->setNumDiasRetornoProgramado(null);
    } else {
      $objEnviarProcessoDTO->setNumDiasRetornoProgramado(trim($objEnviarProcessoDTO->getNumDiasRetornoProgramado()));

      if (!is_numeric($objEnviarProcessoDTO->getNumDiasRetornoProgramado()) || $objEnviarProcessoDTO->getNumDiasRetornoProgramado() < 1) {
  ...
  protected function listarPendenciasRN0754Conectado(PesquisaPendenciaDTO $objPesquisaPendenciaDTO) {
    try {
      ...
      if (!$objPesquisaPendenciaDTO->isSetStrSinReaberturaProgramada()) {
        $objPesquisaPendenciaDTO->setStrSinReaberturaProgramada('N');
      }
      ...
      if (!$objPesquisaPendenciaDTO->isSetStrSinReaberturasProgramadas()) {
        $objPesquisaPendenciaDTO->setStrSinReaberturasProgramadas('N');
      }

      if (!$objPesquisaPendenciaDTO->isSetStrSinAcessoFederacao()) {
        $objPesquisaPendenciaDTO->setStrSinAcessoFederacao('N');
      }

      if (!$objPesquisaPendenciaDTO->isSetStrSinSigilosos()) {
        $objPesquisaPendenciaDTO->setStrSinSigilosos('N');
      }

      if (!$objPesquisaPendenciaDTO->isSetStrSinPrioritarios()) {
        $objPesquisaPendenciaDTO->setStrSinPrioritarios('N');
      }

      if (!$objPesquisaPendenciaDTO->isSetStrSinCredenciaisAssinatura()) {
        $objPesquisaPendenciaDTO->setStrSinCredenciaisAssinatura('N');
      }
      ...
      if (!$objPesquisaPendenciaDTO->isSetStrSinFederacao()) {
        $objPesquisaPendenciaDTO->setStrSinFederacao('N');
      }

      if (!$objPesquisaPendenciaDTO->isSetStrSinSinalizacoes()) {
        $objPesquisaPendenciaDTO->setStrSinSinalizacoes('N');
      }

      if ($objPesquisaPendenciaDTO->getStrSinSinalizacoes() == 'S') {
      ...
      if ($objPesquisaPendenciaDTO->getStrSinReaberturasProgramadas() == 'S') {
        $objAtividadeDTO->setNumTipoVisualizacao(AtividadeRN::$TV_REABERTURA_PROGRAMADA, InfraDTO::$OPER_BIT_AND);
      }

      if ($objPesquisaPendenciaDTO->getStrSinAcessoFederacao() == 'S') {
        $objAtividadeDTO->setNumTipoFkProtocoloFederacao(InfraDTO::$TIPO_FK_OBRIGATORIA);
        $objAtividadeDTO->setNumTipoFkAcessoFederacao(InfraDTO::$TIPO_FK_OBRIGATORIA);
        $objAtividadeDTO->setNumFiltroFkAcessoFederacao(InfraDTO::$FILTRO_FK_WHERE);
        $objAtividadeDTO->setStrIdProcedimentoFederacaoAcessoFederacao(null, InfraDTO::$OPER_DIFERENTE);
      }

      $objAtividadeDTO->setStrStaProtocoloProtocolo(ProtocoloRN::$TP_PROCEDIMENTO);

      if ($objPesquisaPendenciaDTO->getStrSinPrioritarios() == 'S') {
        $objAtividadeDTO->setNumIdTipoPrioridadeProcesso(null, InfraDTO::$OPER_DIFERENTE);
      }
      ...
      if ($objPesquisaPendenciaDTO->getNumIdUsuario() == null) {
        ...
        if ($objPesquisaPendenciaDTO->getStrSinSigilosos() == 'S' || $objPesquisaPendenciaDTO->getStrSinCredenciaisAssinatura() == 'S') {
          $objAtividadeDTO->setNumIdUsuario($objPesquisaPendenciaDTO->getNumIdUsuario());
        } else {
          $objAtividadeDTO->adicionarCriterio(array('StaNivelAcessoGlobalProtocolo', 'IdUsuario'), array(InfraDTO::$OPER_DIFERENTE, InfraDTO::$OPER_IGUAL), array(ProtocoloRN::$NA_SIGILOSO, $objPesquisaPendenciaDTO->getNumIdUsuario()),
      ...
      if ($objPesquisaPendenciaDTO->getStrStaTipoAtribuicao() == self::$TA_MINHAS) {
        ...
        if ($objPesquisaPendenciaDTO->getStrStaTipoAtribuicao() == self::$TA_DEFINIDAS) {
          $objAtividadeDTO->setNumIdUsuarioAtribuicao(null, InfraDTO::$OPER_DIFERENTE);
        } else {
          if ($objPesquisaPendenciaDTO->getStrStaTipoAtribuicao() == self::$TA_ESPECIFICAS) {
      ...
      if ($objPesquisaPendenciaDTO->getStrSinSigilosos() == 'S' || $objPesquisaPendenciaDTO->getStrSinCredenciaisAssinatura() == 'S') {
        $objAtividadeDTO->setStrStaNivelAcessoGlobalProtocolo(ProtocoloRN::$NA_SIGILOSO);
      }

      if ($objPesquisaPendenciaDTO->getStrSinCredenciaisAssinatura() == 'S') {
        $objAcessoDTO = new AcessoDTO();
        ...
        if (count($arrObjAcessoDTO)) {
          $objAtividadeDTO->setDblIdProtocolo(InfraArray::converterArrInfraDTO($arrObjAcessoDTO, 'IdProtocolo'), InfraDTO::$OPER_IN);
        } else {
          $objAtividadeDTO->setDblIdProtocolo(null);
        }
      }
      ...
      if ($objPesquisaPendenciaDTO->isSetNumIdTipoPrioridade()) {
        $objAtividadeDTO->setNumIdTipoPrioridadeProcesso($objPesquisaPendenciaDTO->getNumIdTipoPrioridade());
      }
      ...
      if ($objPesquisaPendenciaDTO->isSetStrStaTipoControlePrazo()) {
        ...
        if ($objPesquisaPendenciaDTO->getStrStaTipoControlePrazo() == self::$TCP_NORMAL) {
          ...
          if ($objPesquisaPendenciaDTO->getStrStaTipoControlePrazo() == self::$TCP_ATRASADO) {
            $objAtividadeDTO->setDtaPrazoControlePrazo(InfraData::getStrDataAtual(), InfraDTO::$OPER_MENOR);
            $objAtividadeDTO->setDtaConclusaoControlePrazo(null);
          } else {
            if ($objPesquisaPendenciaDTO->getStrStaTipoControlePrazo() == self::$TCP_CONCLUIDO) {
      ...
      if ($objPesquisaPendenciaDTO->isSetObjAtividadeDTOOrdenacao()) {
        ...
        if ($objAtividadeDTOOrdenacao->isOrdDblIdProtocolo()) {
          ...
          if ($objAtividadeDTOOrdenacao->isOrdStrSiglaUsuarioAtribuicao()) {
            ...
            if ($objAtividadeDTOOrdenacao->isOrdNumIdAtividade()) {
              ...
              if ($objAtividadeDTOOrdenacao->isOrdStrNomeTipoProcedimentoProtocolo()) {
                ...
                if ($objAtividadeDTOOrdenacao->isOrdStrDescricaoProtocolo()) {
                  ...
                  if ($objAtividadeDTOOrdenacao->isOrdDtaPrazoControlePrazo()) {
                    ...
                    if ($objAtividadeDTOOrdenacao->isOrdNumIdUnidadeRetornoRetornoProgramado()) {
                      $objRetornoProgramadoDTO = new RetornoProgramadoDTO();
                      $objRetornoProgramadoDTO->retNumIdRetornoProgramado();
                      ...
                      if ($objAtividadeDTOOrdenacao->isOrdNumIdUnidadeEnvioRetornoProgramado()) {
                        $objRetornoProgramadoDTO = new RetornoProgramadoDTO();
                        $objRetornoProgramadoDTO->retNumIdRetornoProgramado();
                        $objRetornoProgramadoDTO->retDblIdProtocolo();
                        $objRetornoProgramadoDTO->setNumIdUnidadeEnvio(SessaoSEI::getInstance()->getNumIdUnidadeAtual());
                        ...
                        if ($objAtividadeDTOOrdenacao->isOrdStrDescricaoObservacao()) {
                          ...
                          if ($objAtividadeDTOOrdenacao->isOrdStrDescricaoAnotacao()) {
                            ...
                            $objAtividadeDTO->adicionarCriterio(array(
                                'StaNivelAcessoGlobalProtocolo', 'StaAnotacaoAnotacao'
                              ), array(InfraDTO::$OPER_DIFERENTE, InfraDTO::$OPER_IGUAL), array(ProtocoloRN::$NA_SIGILOSO, AnotacaoRN::$TA_UNIDADE), InfraDTO::$OPER_LOGICO_AND, 'cAnotacaoUnidade');
                            $objAtividadeDTO->adicionarCriterio(array('IdUsuarioAnotacao'), array(InfraDTO::$OPER_IGUAL), array(SessaoSEI::getInstance()->getNumIdUsuario()), null, 'cAnotacaoUsuario');
      ...
      if (!$objPesquisaPendenciaDTO->isSetDblIdProtocolo()) {
        ...
        foreach ($arrAtividadeDTO as $dto) {
          ...
          if (!isset($arrProcessos[$dblIdProtocolo])) {
            ...
            if ($arrProcessos[$dblIdProtocolo] == 1) {
              $arrIdAtividades[] = $dto->getNumIdAtividade();
            }
          }
        }
      ...
      if (count($arrAtividadeDTO)) {
        ...
        if ($objPesquisaPendenciaDTO->getStrSinFederacao() == 'S') {
          $objProcedimentoDTO->setStrSinFederacao('S');
        }
        ...
        if ($objPesquisaPendenciaDTO->getStrSinRetornoProgramado() == 'S') {
          ...
          $objRetornoProgramadoDTO->adicionarCriterio(array('IdUnidadeEnvio', 'IdUnidadeRetorno'), array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
            array($objPesquisaPendenciaDTO->getNumIdUnidade(), $objPesquisaPendenciaDTO->getNumIdUnidade()), InfraDTO::$OPER_LOGICO_OR);
        ...
        $arrObjReaberturaProgramadaDTO = null;
        if ($objPesquisaPendenciaDTO->getStrSinReaberturaProgramada() == 'S') {
          $arrIdProtocolosReabertura = array();
          foreach ($arrAtividadeDTO as $objAtividadeDTO) {
            if ($objAtividadeDTO->getNumTipoVisualizacao() & AtividadeRN::$TV_REABERTURA_PROGRAMADA) {
              $arrIdProtocolosReabertura[$objAtividadeDTO->getDblIdProtocolo()] = true;
            }
          }
          if (count($arrIdProtocolosReabertura)) {
            $objReaberturaProgramadaDTO = new ReaberturaProgramadaDTO();
            ...
            $objReaberturaProgramadaDTO->setDblIdProtocolo(array_keys($arrIdProtocolosReabertura), InfraDTO::$OPER_IN);
            ...
            $objReaberturaProgramadaDTO->setOrdDtaProgramada(InfraDTO::$TIPO_ORDENACAO_DESC);

            $objReaberturaProgramadaBD = new ReaberturaProgramadaBD($this->getObjInfraIBanco());
            $arrObjReaberturaProgramadaDTO = InfraArray::indexarArrInfraDTO($objReaberturaProgramadaBD->listar($objReaberturaProgramadaDTO), 'IdProtocolo', true);
          }
        }
        ...
        foreach ($arrAtividadeDTO as $objAtividadeDTO) {
          ...
          if ($objProcedimentoDTO != null) {
            ...
            if (!isset($arrAdicionados[$dblIdProcedimento])) {
              ...
              if (is_array($arrObjReaberturaProgramadaDTO)) {
                if (isset($arrObjReaberturaProgramadaDTO[$dblIdProcedimento])) {
                  $objProcedimentoDTO->setArrObjReaberturaProgramadaDTO($arrObjReaberturaProgramadaDTO[$dblIdProcedimento]);
                } else {
                  $objProcedimentoDTO->setArrObjReaberturaProgramadaDTO(null);
                }
              }
          ...
          */
          ...
          foreach ($arrObjAcessoDTO as $objAcessoDTO) {
            if ($objAcessoDTO->getStrStaTipo() == AcessoRN::$TA_CREDENCIAL_PROCESSO) {
              ...
              if ($objAcessoDTO->getStrStaTipo() == AcessoRN::$TA_CREDENCIAL_ASSINATURA_PROCESSO) {
          ...
          if ($numEnviados > 1) {
            if ($numEnviados != $numEncontrados) {
              if ($numEncontrados == 0) {
                ...
                if (($numEnviados - $numEncontrados) == 1) {
    ...
    try {
      ...
      if ($parObjAtividadeDTO->isSetBolReplicandoFederacao() && $parObjAtividadeDTO->getBolReplicandoFederacao()) {
        ...
        if ($parObjAtividadeDTO->getNumTipoVisualizacao() & self::$TV_ATENCAO) {
          ...
          if ($parObjAtividadeDTO->getNumTipoVisualizacao() & self::$TV_PUBLICACAO) {
            $numStaTipoReplicacao = ReplicacaoFederacaoRN::$TRF_SINALIZACAO_PUBLICACAO;
          } else {
            if ($parObjAtividadeDTO->getNumTipoVisualizacao() & self::$TV_ENVIO_FEDERACAO) {
              $numStaTipoReplicacao = ReplicacaoFederacaoRN::$TRF_SINALIZACAO_ENVIO;
            } else {
              if ($parObjAtividadeDTO->getNumTipoVisualizacao() & self::$TV_CANCELAMENTO_FEDERACAO) {
  ...
  public function validarAndamentosAtuais($arrIdProtocolo, InfraException $objInfraException) {
  ...
  protected function concederCredencialInternoControlado(ConcederCredencialDTO $parObjConcederCredencialDTO) {
    try {
      ...
      $this->validarAndamentosAtuais(array($parObjConcederCredencialDTO->getDblIdProcedimento()), $objInfraException);
  ...
  protected function listarCredenciaisConectado(ProcedimentoDTO $objProcedimentoDTO) {
    try {
      ...
      $objAtividadeDTO->retNumIdOrgaoUsuario();
      ...
      $objAtividadeDTO->retNumIdOrgaoUsuarioOrigem();
    ...
    try {
      ...
      foreach ($arrObjAtividadeDTO as $objAtividadeDTO) {
        ...
        if ($objAtividadeDTO->getNumIdTarefa() == TarefaRN::$TI_PROCESSO_CONCESSAO_CREDENCIAL) {
          ...
          if ($objAtividadeDTO->getNumIdTarefa() == TarefaRN::$TI_PROCESSO_TRANSFERENCIA_CREDENCIAL) {
            $numIdTarefaCassacao = TarefaRN::$TI_PROCESSO_TRANSFERENCIA_CREDENCIAL_CASSADA;
          } else {
            if ($objAtividadeDTO->getNumIdTarefa() == TarefaRN::$TI_PROCESSO_ATIVACAO_CREDENCIAL) {
    ...
    try {
      ...
      foreach ($arrObjAtividadeDTO as $objAtividadeDTO) {
        ...
        if (count($arr) == 0) {
          ...
          foreach ($arr as $dto) {
            if ($dto->getNumIdTarefa() == TarefaRN::$TI_PROCESSO_RENOVACAO_CREDENCIAL && $dto->getNumTipoVisualizacao() == self::$TV_NAO_VISUALIZADO && $dto->getNumIdUsuarioOrigem() == SessaoSEI::getInstance()->getNumIdUsuario() && $dto->getNumIdUnidadeOrigem() == SessaoSEI::getInstance()->getNumIdUnidadeAtual()) {
  ...
  protected function listarCredenciaisAssinaturaConectado(DocumentoDTO $parObjDocumentoDTO) {
    try {
      ...
      $objAtributoAndamentoDTO->setNumIdTarefaAtividade(array(
        TarefaRN::$TI_CONCESSAO_CREDENCIAL_ASSINATURA, TarefaRN::$TI_CONCESSAO_CREDENCIAL_ASSINATURA_CASSADA, TarefaRN::$TI_CONCESSAO_CREDENCIAL_ASSINATURA_UTILIZADA
      ), InfraDTO::$OPER_IN);
  ...
  protected function concederCredencialAssinaturaInternoControlado(
    ConcederCredencialAssinaturaDTO $parObjConcederCredencialAssinaturaDTO) {
    try {
      //Valida Permissao
      ...
      $this->validarAndamentosAtuais(array($parObjConcederCredencialAssinaturaDTO->getDblIdProcedimento()), $objInfraException);
    ...
    try {
      ...
      foreach ($arrObjAtividadeDTO as $objAtividadeDTO) {
        ...
        if (count($arr) == 0) {
          ...
          $objAcessoDTO->setNumIdUnidade($objAtividadeDTO->getNumIdUnidade());
          $objAcessoDTO->setStrStaTipo(array(
              AcessoRN::$TA_CREDENCIAL_ASSINATURA_PROCESSO, AcessoRN::$TA_CREDENCIAL_ASSINATURA_DOCUMENTO
            ), InfraDTO::$OPER_IN);
  ...
  protected function listarPendenciasPorTipoPrioridadeConectado(PesquisaPendenciaDTO $objPesquisaPendenciaDTO) {
    try {
      $objAtividadeDTO = new AtividadeDTO();
      $objAtividadeDTO->setDistinct(true);
      $objAtividadeDTO->retDblIdProtocolo();
      $objAtividadeDTO->retNumIdTipoPrioridadeProcesso();
      ...
      $arrTiposPrioritarios = array();
      foreach ($arrObjAtividadeDTO as $objAtividadeDTO) {
        if (!isset($arrTiposPrioritarios[$objAtividadeDTO->getNumIdTipoPrioridadeProcesso()])) {
          $arrTiposPrioritarios[$objAtividadeDTO->getNumIdTipoPrioridadeProcesso()] = 1;
        } else {
          $arrTiposPrioritarios[$objAtividadeDTO->getNumIdTipoPrioridadeProcesso()]++;
        }
      }

      $arrObjTipoPrioridadeDTO = array();

      if (InfraArray::contar($arrTiposPrioritarios)) {
        ...
        $objTipoPrioridadeDTO->setNumIdTipoPrioridade(array_keys($arrTiposPrioritarios), InfraDTO::$OPER_IN);
        $objTipoPrioridadeDTO->setOrdStrNome(InfraDTO::$TIPO_ORDENACAO_ASC);

        $objTipoPrioridadeRN = new TipoPrioridadeRN();
        $arrObjTipoPrioridadeDTO = $objTipoPrioridadeRN->listar($objTipoPrioridadeDTO);

        foreach ($arrObjTipoPrioridadeDTO as $dto) {
          $dto->setNumProcessos($arrTiposPrioritarios[$dto->getNumIdTipoPrioridade()]);
        }
      }

      return $arrObjTipoPrioridadeDTO;
    } catch (Exception $e) {
      throw new InfraException('Erro recuperando processos abertos por tipos de processo.', $e);
    }
  }
  ...
  protected function processarPainelConectado(PainelControleDTO $objPainelControleDTO) {
    try {
      ...
      $numIdUsuarioSessao = SessaoSEI::getInstance()->getNumIdusuario();
      ...
      if ($objPainelControleDTO->getStrSinPainelTiposPrioritarios() == 'S') {
        ...
        $objRelUsuarioTipoPrioridadeDTO->setNumIdUsuario($objPainelControleDTO->getNumIdUsuario());
        $objRelUsuarioTipoPrioridadeDTO->setNumIdUnidade($objPainelControleDTO->getNumIdUnidade());

        $objRelUsuarioTipoPrioridadeRN = new RelUsuarioTipoPrioridadeRN();
        $arrObjRelUsuarioTipoPrioridadeDTO = InfraArray::indexarArrInfraDTO($objRelUsuarioTipoPrioridadeRN->listar($objRelUsuarioTipoPrioridadeDTO), 'IdTipoPrioridade');

        $objPainelControleDTO->setStrSinPossuiSelecaoTiposPrioritarios((count($arrObjRelUsuarioTipoPrioridadeDTO) ? 'S' : 'N'));
      }
      ...
      $arrProcessosAtribuidosMim = array();
      $arrProcessosReaberturaProgramada = array();
      $arrUsuarioAtribuicao = array();
      $arrUsuarioAtribuicaoAlterados = array();
      $arrTiposProcessos = array();
      $arrTiposProcessosAlterados = array();
      $arrTiposPrioritarios = array();
      $arrTiposPrioritariosAlterados = array();
      $arrProcessosSigilosos = array();
      $arrProcessosFederacao = array();
      $arrProcessosPrioritarios = array();
      ...
      if ($objPainelControleDTO->getStrSinPainelProcessos() == 'S' || $objPainelControleDTO->getStrSinPainelAtribuicoes() == 'S' || $objPainelControleDTO->getStrSinPainelTiposProcessos() == 'S') {
        ...
        $bolPainelTiposPrioritarios = ($objPainelControleDTO->getStrSinPainelTiposPrioritarios() == 'S');
        ...
        $objAtividadeDTO->retStrStaNivelAcessoGlobalProtocolo();
        $objAtividadeDTO->retStrIdProtocoloFederacaoProtocolo();
        $objAtividadeDTO->retNumIdTipoPrioridadeProcesso();
        ...
        foreach ($arrObjAtividadeDTO as $objAtividadeDTO) {
          ...
          if ($objAtividadeDTO->getStrStaNivelAcessoGlobalProtocolo() == ProtocoloRN::$NA_SIGILOSO) {
            $arrProcessosSigilosos[$dblIdProtocolo] = 0;
          }

          if ($objAtividadeDTO->getStrIdProtocoloFederacaoProtocolo() != null) {
            $arrProcessosFederacao[$objAtividadeDTO->getStrIdProtocoloFederacaoProtocolo()] = 0;
          }

          if ($objAtividadeDTO->getNumIdTipoPrioridadeProcesso() != null) {
            $arrProcessosPrioritarios[$dblIdProtocolo] = 0;
          }
          ...
          if ($numTipoVisualizacao & AtividadeRN::$TV_REABERTURA_PROGRAMADA) {
            $arrProcessosReaberturaProgramada[$dblIdProtocolo] = 0;
          }
          ...
          if ($numIdUsuarioAtribuicao == $numIdUsuarioSessao){
            $arrProcessosAtribuidosMim[$dblIdProtocolo] = 0;
          }
          ...
          if ($bolPainelAtribuicoes) {
            ...
            if ($numIdUsuarioAtribuicao != null) {
              if (!isset($arrAtribuicaoContabilizada[$dblIdProtocolo])) {
                ...
                if ($arrAtribuicaoContabilizada[$dblIdProtocolo] == $numIdUsuarioAtribuicao) {
                  if ($numTipoVisualizacao & AtividadeRN::$TV_ATENCAO) {
                    $arrUsuarioAtribuicaoAlterados[$numIdUsuarioAtribuicao]++;
                  }
                }
          ...
          if ($bolPainelTiposPrioritarios) {
            $numIdTipoPrioritario = $objAtividadeDTO->getNumIdTipoPrioridadeProcesso();

            if (!isset($arrTiposPrioritarios[$numIdTipoPrioritario])) {
              $arrTiposPrioritarios[$numIdTipoPrioritario] = 1;
              $arrTiposPrioritariosAlterados[$numIdTipoPrioritario] = 0;
            } else {
              $arrTiposPrioritarios[$numIdTipoPrioritario]++;
            }

            if ($numTipoVisualizacao & AtividadeRN::$TV_ATENCAO) {
              $arrTiposPrioritariosAlterados[$numIdTipoPrioritario]++;
            }
          }
        }
        ...
        $objPainelControleDTO->setNumProcessosAtribuidosMim(count($arrProcessosAtribuidosMim));
        $objPainelControleDTO->setNumProcessosReaberturaProgramada(count($arrProcessosReaberturaProgramada));
        $objPainelControleDTO->setNumProcessosNaoVisualizados(count($arrProcessosNaoVisualizados));
        $objPainelControleDTO->setNumProcessosSigilosos(count($arrProcessosSigilosos));
        $objPainelControleDTO->setNumProcessosPrioritarios(count($arrProcessosPrioritarios));

        $numCredencialAssinatura = 0;
        if (count($arrProcessosSigilosos)) {
          $objAcessoDTO = new AcessoDTO();
          $objAcessoDTO->setNumIdUsuario($objPainelControleDTO->getNumIdUsuario());
          $objAcessoDTO->setNumIdUnidade($objPainelControleDTO->getNumIdUnidade());
          $objAcessoDTO->setStrStaTipo(AcessoRN::$TA_CREDENCIAL_ASSINATURA_PROCESSO);

          $objAcessoRN = new AcessoRN();
          $arrProcessosSigilosos = array_chunk(array_keys($arrProcessosSigilosos), 100);

          foreach ($arrProcessosSigilosos as $arrPaginaSigilosos) {
            $objAcessoDTO->setDblIdProtocolo($arrPaginaSigilosos, InfraDTO::$OPER_IN);
            $numCredencialAssinatura += $objAcessoRN->contar($objAcessoDTO);
          }
        }
        $objPainelControleDTO->setNumProcessosCredencialAssinatura($numCredencialAssinatura);

        $numFederacao = 0;
        if (count($arrProcessosFederacao)) {
          ...
          $arrProcessosFederacao = array_chunk(array_keys($arrProcessosFederacao), 100);

          foreach ($arrProcessosFederacao as $arrPaginaFederacao) {
            $objAcessoFederacaoDTO->setStrIdProcedimentoFederacao($arrPaginaFederacao, InfraDTO::$OPER_IN);
            $numFederacao += count($objAcessoFederacaoRN->listar($objAcessoFederacaoDTO));
          }
        }
        $objPainelControleDTO->setNumProcessosFederacao($numFederacao);



        //unset($arrProcessosGerados);
        //unset($arrProcessosRecebidos);
        unset($arrProcessosAtribuidosMim);
        unset($arrProcessosReaberturaProgramada);
        unset($arrProcessosNaoVisualizados);
        unset($arrProcessosPrioritarios);
        unset($arrProcessosSigilosos);
        unset($arrProcessosFederacao);
      ...
      if ($objPainelControleDTO->getStrSinPainelTiposPrioritarios() == 'S') {
        ...
        if ($objPainelControleDTO->getStrSinVerSelecaoTiposPrioritarios() == 'S') {
          $arrIdTiposPrioritarios = null;

          if ($objPainelControleDTO->getStrSinPossuiSelecaoTiposPrioritarios() == 'S') {
            if ($objPainelControleDTO->getStrSinVerTiposPrioritariosZerados() == 'S') {
              $arrIdTiposPrioritarios = array_keys($arrObjRelUsuarioTipoPrioridadeDTO);
            } else {
              $arrIdTiposPrioritarios = array_intersect(array_keys($arrTiposPrioritarios), array_keys($arrObjRelUsuarioTipoPrioridadeDTO));
            }
          }

          if ($arrIdTiposPrioritarios != null && count($arrIdTiposPrioritarios)) {
            $objTipoPrioridadeDTO->setNumIdTipoPrioridade($arrIdTiposPrioritarios, InfraDTO::$OPER_IN);
          } else {
            $objTipoPrioridadeDTO->setNumIdTipoPrioridade(null);
          }
        } else {
          if ($objPainelControleDTO->getStrSinVerTiposPrioritariosZerados() == 'N') {
            if (count(array_keys($arrTiposPrioritarios))) {
              $objTipoPrioridadeDTO->setNumIdTipoPrioridade(array_keys($arrTiposPrioritarios), InfraDTO::$OPER_IN);
            } else {
              $objTipoPrioridadeDTO->setNumIdTipoPrioridade(null);
            }
        ...
        foreach ($arrObjTipoPrioridadeDTO as $objTipoPrioridadeDTO) {
          $numIdTipoPrioridade = $objTipoPrioridadeDTO->getNumIdTipoPrioridade();
            if (!isset($arrTiposPrioritarios[$numIdTipoPrioridade])) {
              $objTipoPrioridadeDTO->setNumProcessos(0);
              $objTipoPrioridadeDTO->setNumAlterados(0);
            } else {
              $objTipoPrioridadeDTO->setNumProcessos($arrTiposPrioritarios[$numIdTipoPrioridade]);
              $objTipoPrioridadeDTO->setNumAlterados($arrTiposPrioritariosAlterados[$numIdTipoPrioridade]);
            }
        }

        $objPainelControleDTO->setArrObjTipoPrioridadeDTO($arrObjTipoPrioridadeDTO);

        unset($arrTiposPrioritarios);
        unset($arrTiposPrioritariosAlterados);
      }
      ...
      if ($objPainelControleDTO->getStrSinPainelBlocos() == 'S' || $objPainelControleDTO->getStrSinPainelGruposBlocos() == 'S') {
        ...
        foreach ($arrObjBlocoDTO as $objBlocoDTO) {
          ...
          if ($strStaEstado == BlocoRN::$TE_ABERTO) {
            ...
            if ($strStaEstado == BlocoRN::$TE_DISPONIBILIZADO) {
              ...
              if ($strStaEstado == BlocoRN::$TE_RECEBIDO) {
                ...
                if ($strStaEstado == BlocoRN::$TE_RETORNADO) {
                  $numBlocosRetornados++;
      ...
      if ($objPainelControleDTO->getStrSinPainelControlesPrazos() == 'S') {
        ...
        foreach ($arrObjAtividadeDTO as $objAtividadeDTO) {
          ...
          if ($objAtividadeDTO->getDtaConclusaoControlePrazo() != null) {
            ...
            if (InfraData::compararDatas($strDataAtual, $objAtividadeDTO->getDtaPrazoControlePrazo()) < 0) {
      ...
      if ($objPainelControleDTO->getStrSinPainelRetornosProgramados() == 'S') {
        ...
        $objAtividadeDTO->adicionarCriterio(array('IdUnidadeEnvioRetornoProgramado', 'IdUnidadeRetornoRetornoProgramado'), array(InfraDTO::$OPER_IGUAL, InfraDTO::$OPER_IGUAL),
          array($objPainelControleDTO->getNumIdUnidade(), $objPainelControleDTO->getNumIdUnidade()), InfraDTO::$OPER_LOGICO_OR);
        ...
        foreach ($arrObjAtividadeDTO as $objAtividadeDTO) {
          ...
          if ($objAtividadeDTO->getNumIdUnidadeEnvioRetornoProgramado() == SessaoSEI::getInstance()->getNumIdUnidadeAtual()) {
            if ($objAtividadeDTO->getNumIdAtividadeRetornoRetornoProgramado() != null) {
              ...
              if (InfraData::compararDatas($strDataAtual, $objAtividadeDTO->getDtaProgramadaRetornoProgramado()) >= 0) {
      ...
      if ($objPainelControleDTO->getStrSinPainelAcompanhamentos() == 'S') {
        ...
        if (count($arrIdSigilososUsuario) == 0) {
          ...
          $objAcompanhamentoDTO->adicionarCriterio(array('StaNivelAcessoGlobalProtocolo', 'IdProtocolo'), array(InfraDTO::$OPER_DIFERENTE, InfraDTO::$OPER_IN), array(ProtocoloRN::$NA_SIGILOSO, $arrIdSigilososUsuario),
  ...
  private function configurarFiltroPendencias(AtividadeDTO $objAtividadeDTO, $numIdUnidade, $numIdUsuario) {
    try {
      ...
      $objAtividadeDTO->adicionarCriterio(array('StaNivelAcessoGlobalProtocolo', 'IdUsuario'), array(InfraDTO::$OPER_DIFERENTE, InfraDTO::$OPER_IGUAL), array(ProtocoloRN::$NA_SIGILOSO, $numIdUsuario), array(InfraDTO::$OPER_LOGICO_OR));
    } catch (Exception $e) {
