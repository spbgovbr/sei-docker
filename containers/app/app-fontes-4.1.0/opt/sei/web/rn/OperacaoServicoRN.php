...
class OperacaoServicoRN extends InfraRN
{
    ...
    public static $TS_CONCLUIR_BLOCO = 59;
    public static $TS_REABRIR_BLOCO = 60;
    public static $TS_DEVOLVER_BLOCO = 61;
    public static $TS_REGISTRAR_ANOTACAO = 62;
    public static $TS_LISTAR_TIPOS_PRIORIDADE = 63;
    ...
    public function listarValoresOperacaoServico()
    {
        try {
            ...
            $objTipoOperacaoServicoDTO = new TipoOperacaoServicoDTO();
            $objTipoOperacaoServicoDTO->setNumStaOperacaoServico(self::$TS_CONCLUIR_BLOCO);
            $objTipoOperacaoServicoDTO->setStrDescricao('Concluir Bloco');
            $objTipoOperacaoServicoDTO->setStrOperacao('concluirBloco');
            $objTipoOperacaoServicoDTO->setStrSinConfiguravel('S');
            $arrObjTipoOperacaoServicoDTO[] = $objTipoOperacaoServicoDTO;

            $objTipoOperacaoServicoDTO = new TipoOperacaoServicoDTO();
            $objTipoOperacaoServicoDTO->setNumStaOperacaoServico(self::$TS_REABRIR_BLOCO);
            $objTipoOperacaoServicoDTO->setStrDescricao('Reabrir Bloco');
            $objTipoOperacaoServicoDTO->setStrOperacao('reabrirBloco');
            $objTipoOperacaoServicoDTO->setStrSinConfiguravel('S');
            $arrObjTipoOperacaoServicoDTO[] = $objTipoOperacaoServicoDTO;

            $objTipoOperacaoServicoDTO = new TipoOperacaoServicoDTO();
            $objTipoOperacaoServicoDTO->setNumStaOperacaoServico(self::$TS_DEVOLVER_BLOCO);
            $objTipoOperacaoServicoDTO->setStrDescricao('Devolver Bloco');
            $objTipoOperacaoServicoDTO->setStrOperacao('devolverBloco');
            $objTipoOperacaoServicoDTO->setStrSinConfiguravel('S');
            $arrObjTipoOperacaoServicoDTO[] = $objTipoOperacaoServicoDTO;
            ...
            $objTipoOperacaoServicoDTO = new TipoOperacaoServicoDTO();
            $objTipoOperacaoServicoDTO->setNumStaOperacaoServico(self::$TS_REGISTRAR_ANOTACAO);
            $objTipoOperacaoServicoDTO->setStrDescricao('Registrar Anotação');
            $objTipoOperacaoServicoDTO->setStrOperacao('registrarAnotacao');
            $objTipoOperacaoServicoDTO->setStrSinConfiguravel('S');
            $arrObjTipoOperacaoServicoDTO[] = $objTipoOperacaoServicoDTO;

            $objTipoOperacaoServicoDTO = new TipoOperacaoServicoDTO();
            $objTipoOperacaoServicoDTO->setNumStaOperacaoServico(self::$TS_LISTAR_TIPOS_PRIORIDADE);
            $objTipoOperacaoServicoDTO->setStrDescricao('Listar Tipos de Prioridade');
            $objTipoOperacaoServicoDTO->setStrOperacao('listarTiposPrioridade');
            $objTipoOperacaoServicoDTO->setStrSinConfiguravel('S');
            $arrObjTipoOperacaoServicoDTO[] = $objTipoOperacaoServicoDTO;
    ...
    private function validarNumStaOperacaoServico(
        OperacaoServicoDTO $objOperacaoServicoDTO,
        ...
        if (InfraString::isBolVazia($objOperacaoServicoDTO->getNumStaOperacaoServico())) {
            ...
            if (!in_array(
                $objOperacaoServicoDTO->getNumStaOperacaoServico(),
                InfraArray::converterArrInfraDTO($this->listarValoresOperacaoServico(), 'StaOperacaoServico')
            )) {
    ...
    private function validarNumIdTipoProcedimento(
        OperacaoServicoDTO $objOperacaoServicoDTO,
        InfraException $objInfraException
    ) {
    ...
    protected function cadastrarControlado(OperacaoServicoDTO $objOperacaoServicoDTO)
    {
        try {
            ...
            SessaoSEI::getInstance()->validarAuditarPermissao(
                'operacao_servico_cadastrar',
                __METHOD__,
                $objOperacaoServicoDTO
            );
        ...
        try {
            ...
            if ($this->contar($dto)) {
                $objInfraException->adicionarValidacao(
                    'Já existe uma operação do serviço cadastrada com estas características.'
                );
            }
    ...
    protected function excluirControlado($arrObjOperacaoServicoDTO)
    {
        try {
            //Valida Permissao
            SessaoSEI::getInstance()->validarAuditarPermissao(
                'operacao_servico_excluir',
                __METHOD__,
                $arrObjOperacaoServicoDTO
            );
