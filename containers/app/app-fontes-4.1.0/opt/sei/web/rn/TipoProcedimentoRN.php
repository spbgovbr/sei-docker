...
class TipoProcedimentoRN extends InfraRN {
  ...
  protected function listarTiposUnidadeConectado(TipoProcedimentoDTO $parObjTipoProcedimentoDTO){
    try{
      ...
      if ($objUnidadeDTO==null){
        throw new InfraException('Unidade '.SessaoSEI::getInstance()->getStrSiglaUnidadeAtual().'/'.SessaoSEI::getInstance()->getStrSiglaOrgaoUnidadeAtual().' não encontrada no SEI.');
      }
