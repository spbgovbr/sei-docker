...
class ArquivamentoDTO extends InfraDTO {
  ...
  private $numTipoFkEliminacao = null;
  ...
  public function __construct(){
    ...
    $this->numTipoFkEliminacao = InfraDTO::$TIPO_FK_OPCIONAL;
    parent::__construct();
  }
  ...
  public function montar() {
    ...
    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM,
        'IdAtividadeEliminacao',
        'id_atividade_eliminacao');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR,
      'DescricaoUnidadeLocalizador',
      'uni_loc.descricao',
      'unidade uni_loc');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR,
        'SiglaOrgaoUnidadeLocalizador',
        'org_loc.sigla',
        'orgao org_loc');
    ...
    $this->configurarFK('IdAtividadeEliminacao', 'atividade a6', 'a6.id_atividade',$this->getNumTipoFkEliminacao());
    ...
    $this->configurarFK('IdOrgaoUnidadeadeRecebimento', 'orgao org3', 'org3.id_orgao');
    ...
    $this->configurarFK('IdUnidadeLocalizador', 'unidade uni_loc', 'uni_loc.id_unidade');
    $this->configurarFK('IdOrgaoUnidadeLocalizador', 'orgao org_loc', 'org_loc.id_orgao');
  }
  ...
  public function getNumTipoFkEliminacao()
  {
    return $this->numTipoFkEliminacao;
  }

  public function setNumTipoFkEliminacao($numTipoFkEliminacao)
  {
    $this->numTipoFkEliminacao = $numTipoFkEliminacao;
  }
