...
class DocumentoDTO extends InfraDTO {
  ...
  public function montar() {
    ...
    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_DIN,
                                   'Valor',
                                   'din_valor');
    ...
    $this->adicionarAtributo(InfraDTO::$PREFIXO_STR,'IdOperacao');
    ...
    $this->adicionarAtributo(InfraDTO::$PREFIXO_STR,'SinEmail');
