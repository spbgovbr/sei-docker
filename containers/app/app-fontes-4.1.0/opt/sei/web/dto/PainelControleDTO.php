...
class PainelControleDTO extends InfraDTO
{
    ...
    public function montar()
    {
        ...
        $this->adicionarAtributo(InfraDTO::$PREFIXO_NUM, 'ProcessosAtribuidosMim');
        ...
        $this->adicionarAtributo(InfraDTO::$PREFIXO_NUM, 'ProcessosSigilosos');
        $this->adicionarAtributo(InfraDTO::$PREFIXO_NUM, 'ProcessosCredencialAssinatura');
        $this->adicionarAtributo(InfraDTO::$PREFIXO_NUM, 'ProcessosReaberturaProgramada');
        $this->adicionarAtributo(InfraDTO::$PREFIXO_NUM, 'ProcessosFederacao');
        $this->adicionarAtributo(InfraDTO::$PREFIXO_NUM, 'ProcessosPrioritarios');

        $this->adicionarAtributo(InfraDTO::$PREFIXO_ARR, 'ObjTipoProcedimentoDTO');
        $this->adicionarAtributo(InfraDTO::$PREFIXO_ARR, 'ObjTipoPrioridadeDTO');
        ...
        $this->adicionarAtributo(InfraDTO::$PREFIXO_STR, 'SinPainelTiposPrioritarios');
        ...
        $this->adicionarAtributo(InfraDTO::$PREFIXO_STR, 'SinVerTiposProcessosPrioritarios');
        $this->adicionarAtributo(InfraDTO::$PREFIXO_STR, 'SinPossuiSelecaoTiposPrioritarios');
        $this->adicionarAtributo(InfraDTO::$PREFIXO_STR, 'SinVerSelecaoTiposPrioritarios');
        $this->adicionarAtributo(InfraDTO::$PREFIXO_STR, 'SinVerTiposPrioritariosZerados');
        ...
        $this->adicionarAtributo(InfraDTO::$PREFIXO_STR, 'SinNivelPrioritarios');
