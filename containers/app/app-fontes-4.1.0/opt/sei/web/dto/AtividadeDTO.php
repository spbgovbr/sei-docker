...
class AtividadeDTO extends InfraDTO {
  ...
  private $numTipoFkProtocoloFederacao;
  private $numFiltroFkProtocoloFederacao;

  private $numTipoFkAcessoFederacao;
  private $numFiltroFkAcessoFederacao;
  ...
  public function __construct() {
    ...
    $this->numTipoFkProtocoloFederacao = InfraDTO::$TIPO_FK_OPCIONAL;
    $this->numFiltroFkProtocoloFederacao = InfraDTO::$FILTRO_FK_ON;

    $this->numTipoFkAcessoFederacao = InfraDTO::$TIPO_FK_OPCIONAL;
    $this->numFiltroFkAcessoFederacao = InfraDTO::$FILTRO_FK_ON;
  ...
  public function montar() {
    ...
    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_DTH, 'Abertura', 'dth_abertura');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_DTH, 'Conclusao', 'dth_conclusao');
    ...
    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'IdUsuarioConclusao', 'id_usuario_conclusao');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'IdUsuarioVisualizacao', 'id_usuario_visualizacao');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_NUM, 'TipoVisualizacao', 'tipo_visualizacao');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_DTA, 'Prazo', 'dta_prazo');

    $this->adicionarAtributoTabela(InfraDTO::$PREFIXO_STR, 'SinInicial', 'sin_inicial');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdOrgaoUnidadeOrigem', 'uo.id_orgao', 'unidade uo');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdOrgaoUsuario', 'ua.id_orgao', 'usuario ua');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SiglaUsuarioAtribuicao', 'uat.sigla', 'usuario uat');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'NomeUsuarioAtribuicao', 'uat.nome', 'usuario uat');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdOrgaoUsuarioOrigem', 'ug.id_orgao', 'usuario ug');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SiglaUsuarioOrigem', 'ug.sigla', 'usuario ug');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'NomeUsuarioOrigem', 'ug.nome', 'usuario ug');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SiglaUsuarioConclusao', 'uc.sigla', 'usuario uc');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'NomeUsuarioConclusao', 'uc.nome', 'usuario uc');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'IdProtocoloProtocolo', 'id_protocolo', 'protocolo');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'IdTarefaModuloTarefa', 'id_tarefa_modulo', 'tarefa');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SinHistoricoCompletoTarefa', 'sin_historico_completo', 'tarefa');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SinHistoricoResumidoTarefa', 'sin_historico_resumido', 'tarefa');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SinConsultaProcessualTarefa', 'sin_consulta_processual', 'tarefa');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_DBL, 'IdProcedimentoProtocolo', 'id_procedimento', 'procedimento');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdTipoProcedimentoProtocolo', 'id_tipo_procedimento', 'procedimento');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdTipoPrioridadeProcesso', 'id_tipo_prioridade', 'procedimento');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'NomeTipoProcedimentoProtocolo', 'nome', 'tipo_procedimento');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdMarcador', 'id_marcador', 'andamento_marcador');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'SinUltimoAndamentoMarcador', 'sin_ultimo', 'andamento_marcador');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdUnidadeMarcador', 'id_unidade', 'marcador');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdAcompanhamento', 'id_acompanhamento', 'acompanhamento');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdUnidadeAcompanhamento', 'id_unidade', 'acompanhamento');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdControlePrazo', 'id_controle_prazo', 'controle_prazo');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdUnidadeControlePrazo', 'id_unidade', 'controle_prazo');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_DTA, 'PrazoControlePrazo', 'dta_prazo', 'controle_prazo');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_DTA, 'ConclusaoControlePrazo', 'dta_conclusao', 'controle_prazo');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdRetornoProgramado', 'id_retorno_programado', 'retorno_programado');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdUnidadeEnvioRetornoProgramado', 'id_unidade_envio', 'retorno_programado');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdUnidadeRetornoRetornoProgramado', 'id_unidade_retorno', 'retorno_programado');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdAtividadeRetornoRetornoProgramado', 'id_atividade_retorno', 'retorno_programado');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_DTA, 'ProgramadaRetornoProgramado', 'dta_programada', 'retorno_programado');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdUnidadeObservacao', 'id_unidade', 'observacao');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'DescricaoObservacao', 'descricao', 'observacao');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdUnidadeAnotacao', 'id_unidade', 'anotacao');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_NUM, 'IdUsuarioAnotacao', 'id_usuario', 'anotacao');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'StaAnotacaoAnotacao', 'sta_anotacao', 'anotacao');

    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'DescricaoAnotacao', 'descricao', 'anotacao');
    ...
    $this->adicionarAtributoTabelaRelacionada(InfraDTO::$PREFIXO_STR, 'IdProcedimentoFederacaoAcessoFederacao', 'id_procedimento_federacao', 'acesso_federacao');
    ...
    $this->configurarFK('IdProtocoloFederacaoProtocolo', 'protocolo_federacao', 'id_protocolo_federacao', $this->getNumTipoFkProtocoloFederacao(), $this->getNumFiltroFkProtocoloFederacao());
    $this->configurarFK('IdProtocoloFederacaoProtocoloFederacao', 'acesso_federacao', 'id_procedimento_federacao', $this->getNumTipoFkAcessoFederacao(), $this->getNumFiltroFkAcessoFederacao());
    ...
    $this->configurarFK('IdTipoPrioridadeProcesso', 'tipo_prioridade', 'id_tipo_prioridade', InfraDTO::$TIPO_FK_OPCIONAL);
  ...
  public function getNumTipoFkProtocoloFederacao() {
    return $this->numTipoFkProtocoloFederacao;
  }

  public function setNumTipoFkProtocoloFederacao($numTipoFkProtocoloFederacao) {
    $this->numTipoFkProtocoloFederacao = $numTipoFkProtocoloFederacao;
  }

  public function getNumFiltroFkProtocoloFederacao() {
    return $this->numFiltroFkProtocoloFederacao;
  }

  public function setNumFiltroFkProtocoloFederacao($numFiltroFkProtocoloFederacao) {
    $this->numFiltroFkProtocoloFederacao = $numFiltroFkProtocoloFederacao;
  }

  public function getNumTipoFkAcessoFederacao() {
    return $this->numTipoFkAcessoFederacao;
  }

  public function setNumTipoFkAcessoFederacao($numTipoFkAcessoFederacao) {
    $this->numTipoFkAcessoFederacao = $numTipoFkAcessoFederacao;
  }

  public function getNumFiltroFkAcessoFederacao() {
    return $this->numFiltroFkAcessoFederacao;
  }

  public function setNumFiltroFkAcessoFederacao($numFiltroFkAcessoFederacao) {
    $this->numFiltroFkAcessoFederacao = $numFiltroFkAcessoFederacao;
  }
}
