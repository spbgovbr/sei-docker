...
class DocumentoAPI {
  ...
  private $IdPlanoTrabalho;
  private $IdEtapaTrabalho;
  private $IdItemEtapa;
  private $IdOperacao;
   ...
   * @return mixed
   */
  public function getConteudoSecoes()
  {
    return $this->ConteudoSecoes;
  }

  /**
   * @param mixed $ConteudoSecoes
   */
  public function setConteudoSecoes($ConteudoSecoes)
  {
   ...
   * @return mixed
   */
  public function getDinValor()
  {
    return $this->DinValor;
  }

  /**
   * @param mixed $DinValor
   */
  public function setDinValor($DinValor)
  {
   ...
   * @return mixed
   */
  public function getIdPlanoTrabalho() {
    return $this->IdPlanoTrabalho;
  }

  /**
   * @param mixed $IdPlanoTrabalho
   */
  public function setIdPlanoTrabalho($IdPlanoTrabalho): void {
   ...
   * @return mixed
   */
  public function getIdEtapaTrabalho() {
    return $this->IdEtapaTrabalho;
  }

  /**
   * @param mixed $IdEtapaTrabalho
   */
  public function setIdEtapaTrabalho($IdEtapaTrabalho): void {
    $this->IdEtapaTrabalho = $IdEtapaTrabalho;
  }

  /**
   * @return mixed
   */
  public function getIdItemEtapa() {
    return $this->IdItemEtapa;
  }

  /**
   * @param mixed $IdItemEtapa
   */
  public function setIdItemEtapa($IdItemEtapa): void {
   ...
   */
  public function setIdOperacao($IdOperacao): void {
