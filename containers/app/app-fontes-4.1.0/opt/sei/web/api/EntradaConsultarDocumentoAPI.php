...
class EntradaConsultarDocumentoAPI {
   ...
   * @return mixed
   */
  public function getSinRetornarBlocos()
  {
    return $this->SinRetornarBlocos;
  }

  /**
   * @param mixed $SinRetornarBlocos
   */
  public function setSinRetornarBlocos($SinRetornarBlocos)
  {
    $this->SinRetornarBlocos = $SinRetornarBlocos;
  }
