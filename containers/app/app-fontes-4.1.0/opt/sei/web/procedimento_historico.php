...
try {
  ...
  if ($objProcedimentoHistoricoDTO->getStrStaHistorico()==ProcedimentoRN::$TH_PARCIAL){
    $strLinkTipoHistorico = '<a id="ancTipoHistorico" href="#" onclick="verHistorico(\''.ProcedimentoRN::$TH_RESUMIDO.'\');" class="ancoraPadraoPreta" tabindex="'.PaginaSEI::getInstance()->getProxTabDados().'">Ver histórico resumido</a>';
  }else {
    $strLinkTipoHistorico = '<a id="ancTipoHistorico" href="#" onclick="verHistorico(\''.ProcedimentoRN::$TH_PARCIAL.'\');" class="ancoraPadraoPreta" tabindex="'.PaginaSEI::getInstance()->getProxTabDados().'">Ver histórico completo</a>';
  }
  
  if (SessaoSEI::getInstance()->verificarPermissao('procedimento_historico_total')){
    $strLinkTipoHistoricoTotal = '<a id="ancTipoHistoricoTotal"  href="#" onclick="verHistorico(\''.ProcedimentoRN::$TH_TOTAL.'\');" class="ancoraPadraoPreta" tabindex="'.PaginaSEI::getInstance()->getProxTabDados().'">Ver histórico total</a>';
  }
...
function inicializar(){
  ...
  if (document.getElementById('btnAtualizarAndamento')!=null){
    document.getElementById('btnAtualizarAndamento').focus();
  }else if (document.getElementById('ancTipoHistorico')!=null){
    document.getElementById('ancTipoHistorico').focus();
  }
  infraEfeitoTabelas();
